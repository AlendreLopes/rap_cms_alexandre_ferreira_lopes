...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_teste_de_alergia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_teste_de_alergia");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_teste_de_alergia";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Teste de Alergia</legend>
