...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_pif WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_i_pif");
...
<fieldset>
	...
	<legend align="center">Laudo PIF</legend>
