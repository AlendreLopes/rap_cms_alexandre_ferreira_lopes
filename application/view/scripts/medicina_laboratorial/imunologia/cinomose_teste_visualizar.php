...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_cinomose_teste WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_i_cinomose_teste");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_i_cinomose_teste";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Cinomose Teste</legend>
	...
	<span class="ex_" numero="<?php echo $Numero;?>" celula="_amostra"><span class="ex_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_amostra];?></span></span>
