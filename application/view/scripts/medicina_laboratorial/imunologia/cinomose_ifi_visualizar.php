...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_cinomose_ifi WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_i_cinomose_ifi");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_i_cinomose_ifi";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Cinomose IFA</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
    
    <label class="mensagem">
    
	<strong>Cinomose  IFA</strong>
    
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_ifa"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_ifa]);?></span></span>
	
    </label>
    
    <label class="mensagem">
    
	<strong>Cinomose IFD</strong>
    
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_direta"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_direta]);?></span></span>
