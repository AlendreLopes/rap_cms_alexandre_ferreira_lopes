...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_cinomose_sorologia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_i_cinomose_sorologia");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_i_cinomose_sorologia";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Cinomose Sorologia</legend>
