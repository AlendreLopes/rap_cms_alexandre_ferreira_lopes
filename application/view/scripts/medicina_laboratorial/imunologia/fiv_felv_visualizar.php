...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_fiv_felv WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_i_fiv_felv");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_i_fiv_felv";
			var c_i   = "_id";
			var c_i_v = $("#_id").attr("indice");
			
			$("#fiv").editable("/application/controller/plugins/indexEditar.php",
				{
					indicator  :'Salvando',
					...
					cancel     :'Cancelar',
					width      :100,
					submitdata :{t_t:t_t,c_i:c_i,c_i_v:c_i_v,c_t:"_fiv"}
				}
			);
			
			$("#felv").editable("/application/controller/plugins/indexEditar.php",
				{
					indicator  :'Salvando',
					data       :"{'Positivo':'Positivo','Negativo':'Negativo','selected':'Selecionar'}",
					type       :'select',
					...
					cancel     :'Cancelar',
					width      :100,
					submitdata :{t_t:t_t,c_i:c_i,c_i_v:c_i_v,c_t:"_felv"}
				}
			);
...
<fieldset>
	...
	<legend align="center">Laudo Fiv Felv</legend>
	...
	<span id="fiv"><?php echo $Exame[_fiv];?></span>
	...
	<span id="felv"><?php echo $Exame[_felv];?></span>
