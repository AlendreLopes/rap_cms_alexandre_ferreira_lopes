...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_giardia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_i_giardia");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_i_giardia";
			var c_i   = "_id";
			var c_i_v = $("#_id").attr("indice");
			
			$("#giardia").editable("/application/controller/plugins/indexEditar.php",
				{
					indicator  :'Salvando',
					...
					cancel     :'Cancelar',
					width      :100,
					submitdata :{t_t:t_t,c_i:c_i,c_i_v:c_i_v,c_t:"_giardia"}
				}
			);
...
<fieldset>
	...
	<legend align="center">Laudo Gi&aacute;rdia</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
    <label>
    
	<strong>Gi&aacute;dia</strong>
    
	<span id="giardia"><?php echo $Exame[_giardia];?></span>
