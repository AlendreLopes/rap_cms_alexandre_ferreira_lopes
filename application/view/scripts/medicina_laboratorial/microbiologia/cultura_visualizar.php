...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_m_cultura WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_m_cultura");
...
<fieldset>
	...
	<legend align="center">Laudo Microbiologia Cultura e Antibiograma</legend>
