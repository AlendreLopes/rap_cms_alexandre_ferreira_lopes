...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_m_cultura_urina WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_m_cultura_urina");
...
<head>
	...
	$(document).ready(function(){
			...
			var t_t   = "laudos_ml_m_cultura_urina";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Microbiologia Cultura F&uacute;ngica e Antibiograma</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
    <label class="linha"><strong>Cultura F&uacute;ngica e Antibiograma</strong></label>
  ...
  <label>
	...
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_cultura_urina_antibiograma"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_cultura_urina_antibiograma]);?></span></span>
