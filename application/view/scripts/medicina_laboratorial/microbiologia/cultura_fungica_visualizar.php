...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_m_cultura_fungica WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_m_cultura_fungica");
...
<head>
	...
	$(document).ready(function(){
			...
			var t_t   = "laudos_ml_m_cultura_fungica";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Microbiologia Cultura F&uacute;ngica</legend>
  ...
  <label>
	...
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_cultura_fungica_resultado"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_cultura_fungica_resultado]);?></span></span>
