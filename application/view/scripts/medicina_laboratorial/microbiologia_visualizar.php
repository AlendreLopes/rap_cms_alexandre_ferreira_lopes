...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_microbiologia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_microbiologia");
...
<head>
	...
	$(document).ready(function(){
			...
			var t_t   = "laudos_ml_microbiologia";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Microbiologia</legend>
  ...
  <label>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_cultura_amostra"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo$Exame[_cultura_amostra];?></span></span>
	...
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_cultura_resultado"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_cultura_resultado]);?></span></span>
    ...
    <span class="ed_" numero="<?php echo $Numero;?>" celula="_cultura_antibiograma"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_cultura_antibiograma]);?></span></span>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_cultura_fungica_amostra"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo$Exame[_cultura_fungica_amostra];?></span></span>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_cultura_fungica_resultado"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo$Exame[_cultura_fungica_resultado];?></span></span>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_cultura_urina_amostra"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo$Exame[_cultura_urina_amostra];?></span></span>
	...
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_cultura_urina_resultado"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_cultura_urina_resultado]);?></span></span>
