...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_toxicologico WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_toxicologico");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_toxicologico";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Toxicologico</legend>
	...
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_amostra"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_amostra]); ?></span></span>
