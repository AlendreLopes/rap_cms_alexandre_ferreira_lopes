...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_microscopia_eletronica WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_microscopia_eletronica");
...
<head>
	...
	$(document).ready(function(){
			...
			var t_t   = "laudos_ml_microscopia_eletronica";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Microscopia Eletr&ocirc;nica</legend>
