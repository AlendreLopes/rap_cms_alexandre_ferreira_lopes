...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_doencas_geneticas WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_doencas_geneticas");
...
<head>
	...
	$(document).ready(function(){
			...
			var t_t   = "laudos_ml_doencas_geneticas";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Doen&ccedil;as Gen&eacute;ticas</legend>
