...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_u_proteina_creatinina WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_u_proteina_creatinina";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Rela&ccedil;&atilde;o Prote&iacute;na : Creatinina</legend>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_proteina"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_proteina];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_creatinina"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_creatinina];?></span></span>
	...
	<strong>Rela&ccedil;&atilde;o:</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_proteina_creatinina"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_proteina_creatinina];?></span></span>
