...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_u_transcrever_exames WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_u_transcrever_exames";
			var c_i   = "_id";
