...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_u_calcio_creatinina WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_u_calcio_creatinina";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Rela&ccedil;&atilde;o C&aacute;lcio : Creatinina</legend>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_calcio_creatinina"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_calcio_creatinina];?></span></span>
