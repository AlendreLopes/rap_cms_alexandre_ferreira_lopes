...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_u_analise_fisico WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_u_analise_fisico";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo An&aacute;lise F&iacute;sico-Qu&iacute;mica</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
    <label class="linha">&nbsp;</label>
    
    <label class="linha"><strong>Caracteres F&iacute;sicos</strong></label>
	
    <label>
    
	<strong>Forma</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_forma"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_forma];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Dimens&otilde;es</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_dimensoes"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_dimensoes];?></span></span>
	...
	<strong>Consist&ecirc;ncia</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_consistencia"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_consistencia];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_superficie"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_superficie];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_peso"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_peso];?></span></span>
	...
	<strong>Carbonato</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_carbonato"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_carbonato];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Oxalato</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_oxalato"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_oxalato];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_calcio"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_calcio];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Fosfato</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_fosfato"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_fosfato];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_magnesio"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_magnesio];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Amonio</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_amonio"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_amonio];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_urato"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_urato];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Cistina</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_cistina"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_cistina];?></span></span>
