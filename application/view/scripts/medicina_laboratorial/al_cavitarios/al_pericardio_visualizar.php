...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_al_pericardio WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_al_pericardio");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_al_pericardio";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo A L Peric&aacute;rdio</legend>
