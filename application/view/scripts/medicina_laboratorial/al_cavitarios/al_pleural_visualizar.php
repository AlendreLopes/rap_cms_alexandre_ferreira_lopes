...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_al_pleural WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_al_pleural");
...
<fieldset>
	...
	<legend align="center">Laudo A L Pleural</legend>
