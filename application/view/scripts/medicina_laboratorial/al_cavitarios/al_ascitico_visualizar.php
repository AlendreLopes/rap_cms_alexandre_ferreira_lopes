...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_al_ascitico WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_al_ascitico");
...
<fieldset>
	...
	<legend align="center">Laudo A L &Aacute;scitico</legend>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_amilase"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_amilase];?></span></span>
