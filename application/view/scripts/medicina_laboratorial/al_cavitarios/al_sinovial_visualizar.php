...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_al_sinovial WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_al_sinovial");
...
<fieldset>
	...
	<legend align="center">Laudo A L Sinovial</legend>
	...
	<strong>Mucina</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_mucina"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_mucina];?></span></span>
	...
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_observacao"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>>
	<?php echo $Exame[_observacao];?></span></span>
