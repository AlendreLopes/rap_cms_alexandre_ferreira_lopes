...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_biologia_molecular WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_biologia_molecular");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_biologia_molecular";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Biologia Molecular</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
	<label class="mensagem">
	
	<strong>Relat&oacute;rio Molecular</strong>
