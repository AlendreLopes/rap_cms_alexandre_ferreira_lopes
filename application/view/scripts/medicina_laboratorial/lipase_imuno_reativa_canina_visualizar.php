...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_lipase_imuno_reativa_canina WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_lipase_imuno_reativa_canina");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_lipase_imuno_reativa_canina";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Lipase Imuno Reativa Canina</legend>
