...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_relatorio_de_exames WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_e_relatorio_de_exames");
...
<head>
	...
	$(document).ready(function(){
		...
		var c_i_v_l = $("#protocolo_id").attr("indice");
			...
			var t_t   = "laudos_ml_e_relatorio_de_exames";
			var c_i   = "_id";
