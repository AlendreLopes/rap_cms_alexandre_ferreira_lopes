...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_endocrinologia_ria WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_e_endocrinologia_ria");
...
<head>
	...
	$(document).ready(function(){
			...
			var t_t   = "laudos_ml_e_endocrinologia_ria";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Endocrinologia RIE</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
	<label>
	
    <strong>Cortisol</strong> <span class="e_" numero="<?php echo $Numero;?>" celula="_cortisol"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_cortisol];?></span></span>
    ...
    <strong>T4 Livre por Di&aacute;lise</strong> <span class="e_" numero="<?php echo $Numero;?>" celula="_t4_livre_dialise"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_t4_livre_dialise];?></span></span>
	
    </label>
	
	<label>
	
    <strong>T3 Total</strong> <span class="e_" numero="<?php echo $Numero;?>" celula="_t3_total"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_t3_total];?></span></span>
