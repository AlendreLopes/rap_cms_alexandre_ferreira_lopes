...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_teste_de_supressao_i WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_e_teste_de_supressao_i");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_e_teste_de_supressao_i";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Teste de Supress&atilde;o</legend>
	...
	<span class="ee_" numero="<?php echo $Numero;?>" celula="_titulo"><span class="ee_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_titulo];?></span></span>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_b"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_b];?></span></span>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_4_h"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_4_h];?></span></span>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_8_h"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_8_h];?></span></span>
