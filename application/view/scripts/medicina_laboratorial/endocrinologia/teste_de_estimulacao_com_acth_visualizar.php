...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_teste_de_estimulacao_com_acth WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_e_teste_de_estimulacao_com_acth");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_e_teste_de_estimulacao_com_acth";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Teste de Estimula&ccedil;&atilde;o ACTH</legend>
    ...
    <strong>Cortisol P&oacute;s-Acth</strong>
    
	<span class="e_" numero="<?php echo $Numero;?>" celula="_cortisol_p_acth"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_cortisol_p_acth];?></span></span>
