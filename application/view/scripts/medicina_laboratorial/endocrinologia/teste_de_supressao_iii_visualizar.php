...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_teste_de_supressao_iii WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_e_teste_de_supressao_iii");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_e_teste_de_supressao_iii";
			var c_i   = "_id";
			...
			// Por extenso
			$(".ee_").live('click',function(){
				var numero = $(this).attr("numero");
				var celula = $(this).attr("celula");
				$(".ee_" + numero).editable("/application/controller/plugins/indexEditar.php",
					{
						indicator  :'Salvando',
						width      :550,
						submitdata :{t_t:t_t,c_i:c_i,c_i_v:c_i_v,c_t:celula}
...
<fieldset>
	...
	<legend align="center">Laudo Teste de Supress&atilde;o 3 Doses RIA</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
    <label class="linha">
    
    <strong>Cortisol Basal</strong>
    
	<span class="e_" numero="<?php echo $Numero;?>" celula="_cortisol_basal"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_cortisol_basal];?></span></span>
	
	</label>
	
	<label>
	
    <strong>Cortisol 4 Horas</strong>
    
	<span class="e_" numero="<?php echo $Numero;?>" celula="_cortisol_4_h"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_cortisol_4_h];?></span></span>
	
	</label>
	
	<label>
	
    <strong>Cortisol 8 Horas</strong>
    
	<span class="e_" numero="<?php echo $Numero;?>" celula="_cortisol_8_h"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_cortisol_8_h];?></span></span>
