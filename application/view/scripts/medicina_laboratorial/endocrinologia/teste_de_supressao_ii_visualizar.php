...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_teste_de_supressao_ii WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_e_teste_de_supressao_ii");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_e_teste_de_supressao_ii";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Teste de Supress&atilde;o 2 Doses RIA</legend>
