...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_genetica WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_genetica");
...
<fieldset>
	...
	<legend align="center">Laudo Gen&eacute;tica</legend>
