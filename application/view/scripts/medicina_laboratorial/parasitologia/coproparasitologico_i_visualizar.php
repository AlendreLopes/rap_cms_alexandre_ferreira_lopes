...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_p_coproparasitologico_i WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_p_coproparasitologico_i");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_p_coproparasitologico_i";
			var c_i   = "_id";
...
<fieldset>
	...
	<strong>Ancylostoma</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_ancylostoma"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_ancylostoma];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Dipilydium</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_dipilydium"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_dipilydium];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Toxocara</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_toxocara"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_toxocara];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Trichuris</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_trichuris"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_trichuris];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Eimeria</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_eimeria"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_eimeria];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Isospora</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_isospora"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_isospora];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Toxoplasma</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_toxoplasma"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_toxoplasma];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_giardia"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_giardia];?></span></span>
