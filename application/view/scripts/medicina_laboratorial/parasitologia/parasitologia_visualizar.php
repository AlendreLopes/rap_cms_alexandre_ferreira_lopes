...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_p_parasitologia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_p_parasitologia");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_p_parasitologia";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Parasitologia</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
    <label>
    
	<strong>Otodectes</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_otodectes"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_otodectes];?></span></span>
	
    </label>
	
    <label>
    
	<strong>Malassezia</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_malassezia"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_malassezia];?></span></span>
