...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_p_ps_de_sangue_oculto WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_p_ps_de_sangue_oculto");
...
<head>
	...
	$(document).ready(function(){
		...
		var c_i_v_l = $("#protocolo_id").attr("indice");
			...
			var t_t   = "laudos_ml_p_ps_de_sangue_oculto";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo PS Sangue Oculto</legend>
