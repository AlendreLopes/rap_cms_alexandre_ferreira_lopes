...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_p_coprologico WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_p_coprologico");
...
<head>
	...
	$(document).ready(function(){
			...
			var t_t   = "laudos_ml_p_coprologico";
			var c_i   = "_id";
			var c_i_v = $("#_id").attr("indice");

			$("#tripsina").editable("/application/controller/plugins/indexEditar.php",
				{
					indicator  :'Salvando',
					data       :"{'Positivo':'Positivo','Negativo':'Negativo','selected':'Selecionar'}",
					type       :'select',
					submit     :'Editar',
					cancel     :'Cancelar',
					width      :100,
					submitdata :{t_t:t_t,c_i:c_i,c_i_v:c_i_v,c_t:"_tripsina"}
				}
			);
...
<fieldset>
	...
	<legend align="center">Laudo Coprol&oacute;gico Funcional</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
    <label class="linha">
    
	<strong>Tripsina</strong>
    
    <span id="tripsina"><?php echo $Exame[_tripsina];?></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_fibras"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_fibras];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_amido"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_amido];?></span></span>
	...
	<strong>Gordura Fecal</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_gordura_fecal"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_gordura_fecal];?></span></span>
    ...
    <span class="ed_" numero="<?php echo $Numero;?>" celula="_resultado"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_resultado]);?></span></span>
