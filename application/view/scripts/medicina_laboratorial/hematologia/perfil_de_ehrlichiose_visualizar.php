...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ps_de_ehrlichiose WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_ps_de_ehrlichiose");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_ps_de_ehrlichiose";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Perfil de Ehrlichiose</legend>
    ...
    <span class="ed_" numero="<?php echo $Numero;?>" celula="_aspecto_celular"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_aspecto_celular];?></span></span>
