...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_kit_hematozoarios WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_kit_hematozoarios");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_kit_hematozoarios";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Kit Hematozo&aacute;rios</legend>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_mycoplasma"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_mycoplasma];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_ehrlichia"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_ehrlichia];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_babesia"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_babesia];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_dirofilaria"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_dirofilaria];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Dipetalonema</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_dipetalonema"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_dipetalonema];?></span></span>
