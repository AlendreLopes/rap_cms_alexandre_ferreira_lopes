...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ps_de_hematozoarios_i WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_ps_de_hematozoarios_i");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_ps_de_hematozoarios_i";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo PS de Hematozo&aacute;rios</legend>
