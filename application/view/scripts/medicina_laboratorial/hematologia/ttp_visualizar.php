...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ttp WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_ttp");
...
<fieldset>
	...
	<legend align="center">Laudo TTP</legend>
