...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ps_de_hematozoarios_ii WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_ps_de_hematozoarios_ii");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_ps_de_hematozoarios_ii";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo PS de Hematozo&aacute;rios Equino</legend>
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
    <label><strong>Babesia</strong><span class="e_" numero="<?php echo $Numero;?>" celula="_mycoplasma"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_mycoplasma];?></span></span>
	
    </label>
    
    <label><strong>Theileria</strong><span class="e_" numero="<?php echo $Numero;?>" celula="_ehrlichia"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_ehrlichia];?></span></span>
