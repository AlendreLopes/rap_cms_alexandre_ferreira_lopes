...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hemograma_ovino WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_hemograma_ovino");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_hemograma_ovino";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Hemograma Ovino</legend>
	...
	<strong>Valor de Refer&ecirc;ncia</strong>
