...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_contagem_de_reticulocitos WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_contagem_de_reticulocitos");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_contagem_de_reticulocitos";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Contagem de Reticulocitos</legend>
    ...
    <span class="e_" numero="<?php // echo $Numero;?>" celula="_reticulocitos_a"><span class="e_<?php // echo $Numero;?>" <?php // $Numero ++;?>><?php // echo $Exame[_reticulocitos_a];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_reticulocitos_r"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_reticulocitos_r];?></span></span>
