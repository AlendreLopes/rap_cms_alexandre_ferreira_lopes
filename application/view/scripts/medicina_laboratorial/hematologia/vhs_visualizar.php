...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_vhs WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_vhs");
...
<fieldset>
	...
	<legend align="center">Laudo VHS</legend>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_vhs"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_vhs];?></span></span>
