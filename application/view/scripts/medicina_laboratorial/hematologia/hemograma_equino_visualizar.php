...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hemograma_equino WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_hemograma_equino");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_hemograma_equino";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Hemograma Equino</legend>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_fibrogenio"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_fibrogenio];?></span></span>
