...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ps_de_microfilarias WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_ps_de_microfilarias");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_ps_de_microfilarias";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo PS de Microfil&aacute;rias</legend>
