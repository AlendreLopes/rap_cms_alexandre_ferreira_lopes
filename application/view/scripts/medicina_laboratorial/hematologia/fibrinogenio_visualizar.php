...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_fibrogenio WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_fibrogenio");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_fibrogenio";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Fibrinog&ecirc;nio</legend>
