...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_contagem_de_plaquetas WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_contagem_de_plaquetas");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_contagem_de_plaquetas";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Contagem de Plaquetas</legend>
	...
	<strong>Plaquetas Amostra</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_plaquetas_a"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_plaquetas_a];?></span></span>
