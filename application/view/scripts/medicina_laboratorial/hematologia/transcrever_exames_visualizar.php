...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_transcrever_exames WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_transcrever_exames");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_transcrever_exames";
			var c_i   = "_id";
			var c_i_v = $("#_id").attr("indice");
			
			$(".campo_duplo").live('click',function(){
				var Numero = $(this).attr("numero");
				var Celula = $(this).attr("celula");
...
<fieldset>
	...
	<legend align="center">Laudo Transcrever Exames</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
    <label class="mensagem">
    
	<strong>Transcrever Exames Transcrito</strong>
    
    <span class="ed_" numero="<?php echo $Numero;?>" celula="_transcrito"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_transcrito]);?></span></span>
