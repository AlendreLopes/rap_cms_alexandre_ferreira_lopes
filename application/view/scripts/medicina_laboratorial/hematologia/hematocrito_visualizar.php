...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hematocrito WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_hematocrito");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_h_hematocrito";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Hematocrito</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
    <label class="linha"><strong>Hemat&oacute;crito</strong></label>
    
    <label>
    
	<strong>M&eacute;todo</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_hematocrito_metodo"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_hematocrito_metodo];?></span></span>
    ...
    <span class="ed_" numero="<?php echo $Numero;?>" celula="_hematocrito_observacao"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_hematocrito_observacao]);?></span></span>
    
    </label>
    
    <!--
    
    <label class="linha"><strong>Proteina Plasm&aacute;tica</strong></label>
    
    <label>
    
	<strong>M&eacute;todo</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_proteina_plasmatica_metodo"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_proteina_plasmatica_metodo];?></span></span>
	
    </label>
    
    <label>
    
	<strong>Proteina Plasm&aacute;tica</strong>
    
    <span class="e_" numero="<?php echo $Numero;?>" celula="_proteina_plasmatica"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_proteina_plasmatica];?></span></span>
    ...
    <span class="ed_" numero="<?php echo $Numero;?>" celula="_proteina_plasmatica_observacao"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_proteina_plasmatica_observacao]);?></span></span>
