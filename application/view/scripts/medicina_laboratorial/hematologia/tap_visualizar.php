...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_tap WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_h_tap");
...
<fieldset>
	...
	<legend align="center">Laudo TAP</legend>
