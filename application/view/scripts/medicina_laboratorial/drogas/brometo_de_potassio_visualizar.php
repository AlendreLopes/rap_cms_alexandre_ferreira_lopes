...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_dg_brometo_de_potassio WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_dg_brometo_de_potassio");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_dg_brometo_de_potassio";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Brometo de Pot&aacute;ssio</legend>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_metodo"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_metodo];?></span></span>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_resultado"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_resultado];?></span></span>
