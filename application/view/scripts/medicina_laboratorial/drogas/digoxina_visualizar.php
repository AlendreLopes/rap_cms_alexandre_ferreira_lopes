...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_dg_digoxina WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_dg_digoxina");
...
<fieldset>
	...
	<legend align="center">Laudo Digoxina</legend>
