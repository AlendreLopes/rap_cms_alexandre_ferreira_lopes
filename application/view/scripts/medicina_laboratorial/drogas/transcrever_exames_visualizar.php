...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_dg_transcrever_exames WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ml_dg_transcrever_exames");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ml_dg_transcrever_exames";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo  Relat&oacute;rio de Exames</legend>
