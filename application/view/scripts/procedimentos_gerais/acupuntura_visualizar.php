...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_sc_acupuntura WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_sc_acupuntura");
...
<fieldset>
	...
	<legend align="center">Laudo Acupuntura</legend>
