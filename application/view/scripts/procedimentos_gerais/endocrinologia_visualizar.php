...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_sc_endocrinologia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_sc_endocrinologia");
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			*/
			...
			var t_t   = "laudos_sc_endocrinologia";
			var c_i   = "_id";
