...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_raio_x WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_di_raio_x");
...
<fieldset>
	...
	<legend align="center">Laudo Raio-x</legend>
	
	<span id="_id" indice="<?php echo $Exame[_id];?>"></span>
	
	<label>
	
	<strong>Regi&atilde;o:</strong>
	
    <span class="e_" numero="<?php echo $Numero;?>" celula="_regiao"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_regiao];?></span></span>
