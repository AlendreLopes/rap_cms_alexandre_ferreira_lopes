...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_us_gestacional WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_di_us_gestacional");
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			*/
			...
			var t_t   = "laudos_di_us_gestacional";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo US Gestacional</legend>
