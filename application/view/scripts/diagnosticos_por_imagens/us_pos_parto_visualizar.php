...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_us_pos_parto WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_di_us_pos_parto");
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			*/
			...
			var t_t   = "laudos_di_us_pos_parto";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo US P&oacute;s Parto</legend>
