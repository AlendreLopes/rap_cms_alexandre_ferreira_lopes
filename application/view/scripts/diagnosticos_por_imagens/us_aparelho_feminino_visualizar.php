...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_us_aparelho_feminino WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_di_us_aparelho_feminino");
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			*/
			...
			var t_t   = "laudos_di_us_aparelho_feminino";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo US Aparelho Feminino</legend>
