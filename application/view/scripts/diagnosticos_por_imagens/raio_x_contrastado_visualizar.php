...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_raio_x_contrastado WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_di_raio_x_contrastado");
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			*/
			...
			var t_t   = "laudos_di_raio_x_contrastado";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Raio-x Contrastado</legend>
    ...
    <span class="e_" numero="<?php echo $Numero;?>" celula="_tecnica"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_tecnica];?></span></span>
	...
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_descricao"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_descricao]);?></span></span>
