...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_sc_fisioterapia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Fisioterapia.
...
{	
	...
	<legend>Laudo de Fisioterapia</legend>
	
	<form id="formulario" action="/application/models/procedimentos_gerais/fisioterapia_cadastrar.php" method="post">
