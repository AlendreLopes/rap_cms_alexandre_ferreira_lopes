...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_sc_acupuntura WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Acupuntura.
...
{	
	...
	<legend>Laudo de Acupuntura</legend>
	
	<form id="formulario" action="/application/models/procedimentos_gerais/acupuntura_cadastrar.php" method="post">
