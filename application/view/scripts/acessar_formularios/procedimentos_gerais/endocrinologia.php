...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_sc_endocrinologia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Endocrinologia.
...
{	
	...
	<legend>Laudo de Endocrinologia</legend>
	
	<form id="formulario" action="/application/models/procedimentos_gerais/endocrinologia_cadastrar.php" method="post">
