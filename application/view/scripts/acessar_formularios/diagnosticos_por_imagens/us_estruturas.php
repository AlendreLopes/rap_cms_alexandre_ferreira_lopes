...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_us_estruturas WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de US Estruturas.
...
{	
	...
	<legend>Laudo de US Estruturas</legend>
	
	<form id="formulario" action="/application/models/diagnosticos_por_imagens/us_estruturas_cadastrar.php" method="post">
