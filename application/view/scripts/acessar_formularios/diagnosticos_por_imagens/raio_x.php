...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_raio_x WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de  Raio-x.
...
{	
	...
	<legend>Laudo de Raio-x</legend>
	
	<form id="formulario" action="/application/models/diagnosticos_por_imagens/raio_x_cadastrar.php" method="post">
