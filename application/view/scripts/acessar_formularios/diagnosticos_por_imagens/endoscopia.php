...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_endoscopia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Endoscopia.
...
{	
	...
	<legend>Laudo de Endoscopia</legend>
	
	<form id="formulario" action="/application/models/diagnosticos_por_imagens/endoscopia_cadastrar.php" method="post">
