...
<head>
	...
	<title>US P&oacute;s-parto</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_us_pos_parto WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de US P&oacute;s-parto.
...
{	
	...
	<legend>Laudo de US P&oacute;s-parto</legend>
	
	<form id="formulario" action="/application/models/diagnosticos_por_imagens/us_pos_parto_cadastrar.php" method="post">
	...
	<textarea name="c_2">&Uacute;tero com distens&atilde;o mediana, parede espessada, mucosa regular e conte&uacute;do anecog&ecirc;nico.

N&atilde;o h&aacute; evid&ecirc;ncias sonogr&aacute;ficas de fetos retidos.

Conclus&atilde;o: Imagens compat&iacute;veis com fase p&oacute;s-parto</textarea>
