...
<head>
	...
	<title>Raio-x Contrastado</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_di_raio_x_contrastado WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Raio-x Contrastado.
...
{	
	...
	<legend>Laudo de Raio-x Contrastado</legend>
	
	<form id="formulario" action="/application/models/diagnosticos_por_imagens/raio_x_contrastado_cadastrar.php" method="post">
