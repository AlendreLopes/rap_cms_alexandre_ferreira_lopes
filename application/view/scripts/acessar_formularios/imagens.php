...
<div id="img_editar">
<!-- Para evitar bug no Swfupload já que existe um ordem para esconder este div na edição -->
</div>
...
<form id="form1" action="http://reports.petimagem.com.br/application/models/imagens_cadastrar.php" method="post" enctype="multipart/form-data">
	
	<div class="fieldset flash" id="fsUploadProgress">
		<span class="legend">Fila de transferência</span>
	</div>
...
<div id="cadastrado">
	[ <a href="<?php echo LMPaginas::Listar(str_replace('_imagens','',$pagina).'_visualizar',$imagem);?>" title="Visualizar Laudo">Cadastro Concluido</a> ]
</div>

<div id="cancelar">
	[ <a href="<?php echo LMPaginas::Listar(str_replace('_imagens','',$pagina).'_visualizar',$imagem);?>" title="Visualizar Laudo">Cancelar Cadastro</a> ]
</div>
