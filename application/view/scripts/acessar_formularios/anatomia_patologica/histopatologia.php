...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ap_histopatologia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Histopatologia.
...
{	
	...
	<legend>Laudo de Histopatologia</legend>
	
	<form id="formulario" method="post" action="/application/models/anatomia_patologica/histopatologia_cadastrar.php">
