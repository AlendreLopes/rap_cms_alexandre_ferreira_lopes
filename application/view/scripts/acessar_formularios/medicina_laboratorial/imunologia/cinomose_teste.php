...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_cinomose_teste WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Cinomose Teste.
...
{	
	...
	<legend>Laudo de Cinomose Teste</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/imunologia/cinomose_teste_cadastrar.php" method="post">
