...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_dirofilariose WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Dirofilariose.
...
{	
	...
	<legend>Laudo de Dirofilariose</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/imunologia/dirofilariose_cadastrar.php" method="post">
	
    <input type="hidden" name="laudo" value="<?php echo $indice;?>" />
    
	<label>
	
	Dirofilaria Positivo
	...
	Anaplasma Positivo
    <input type="checkbox" name="c_4_1" value="Positivo" style="float:left;" />
