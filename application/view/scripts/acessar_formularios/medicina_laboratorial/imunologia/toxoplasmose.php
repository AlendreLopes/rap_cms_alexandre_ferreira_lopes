...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_toxoplasmose WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Toxoplasmose.
...
{	
	...
	<legend>Laudo de Toxoplasmose</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/imunologia/toxoplasmose_cadastrar.php" method="post">
