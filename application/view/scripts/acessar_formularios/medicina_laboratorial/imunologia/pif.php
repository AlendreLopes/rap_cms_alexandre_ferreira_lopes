...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_pif WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de PIF.
...
{	
	...
	<legend>Laudo de PIF</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/imunologia/pif_cadastrar.php" method="post">
