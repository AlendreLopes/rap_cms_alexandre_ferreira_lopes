...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_giardia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Gi&aacute;rdia.
...
{	
	...
	<legend>Laudo de Gi&aacute;rdia</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/imunologia/giardia_cadastrar.php" method="post">
