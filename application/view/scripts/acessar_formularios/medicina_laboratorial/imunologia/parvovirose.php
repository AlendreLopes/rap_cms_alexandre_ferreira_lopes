...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_parvovirose WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Parvovirose.
...
{	
	...
	<legend>Laudo de Parvovirose</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/imunologia/parvovirose_cadastrar.php" method="post">
	...
	<input type="checkbox" name="c_0_1" value="Positivo" />
	...
	<input type="checkbox" name="c_0_2" value="Positivo" />
