...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_leishmaniose WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Leishmaniose.
...
{	
	...
	<legend>Laudo de Leishmaniose IGg Canina</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/imunologia/leishmaniose_cadastrar.php" method="post">
