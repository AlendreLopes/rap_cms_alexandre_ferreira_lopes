...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_cinomose_ifi WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Cinomose IFI.
...
{	
	...
	<legend>Laudo de Cinomose IFI</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/imunologia/cinomose_ifi_cadastrar.php" method="post">
