...
<head>
	...
	<title>Cinomose Sorologia</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_i_cinomose_sorologia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Cinomose Sorologia.
...
{	
	...
	<legend>Laudo de Cinomose Sorologia</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/imunologia/cinomose_sorologia_cadastrar.php" method="post">
