...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_u_parcial_de_urina WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Parcial de Urina.
...
{	
	...
	<legend>Laudo de Parcial de Urina</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/urinalise/parcial_de_urina_cadastrar.php" method="post">
