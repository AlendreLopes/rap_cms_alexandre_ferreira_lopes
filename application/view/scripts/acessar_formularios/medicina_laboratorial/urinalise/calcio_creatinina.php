...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_u_calcio_creatinina WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
	  ...
	  J&aacute; cadastrado nos Laudos de Rela&ccedil;&atilde;o Calcio : Creatinina. </strong>
...
{	
    ...
    <legend>Laudo de Rela&ccedil;&atilde;o C&aacute;cio : Creatinina</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/urinalise/calcio_creatinina_cadastrar.php" method="post">
