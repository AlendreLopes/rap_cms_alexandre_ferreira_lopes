...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_u_transcrever_exames WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
{	
	...
	<form id="formulario" action="/application/models/medicina_laboratorial/urinalise/transcrever_exames_cadastrar.php" method="post">
