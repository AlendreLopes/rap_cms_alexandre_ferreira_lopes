...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_relatorio_de_exames WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Relat&oacute;rio de Exames Hormonais.
...
{	
	...
	<legend>Laudo de Relat&oacute;rio de Exames Hormonais</legend>
    
	<form id="formulario" action="/application/models/medicina_laboratorial/endocrinologia/relatorio_de_exames_cadastrar.php" method="post">
