...
<head>
	...
	<title>Teste de Supress&atilde;o</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_teste_de_supressao_i WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Teste de Supress&atilde;o a  Dexametasona.
...
{	
	...
	<legend>Laudo de Teste de Supress&atilde;o a Dexametasona</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/endocrinologia/teste_de_supressao_i_cadastrar.php" method="post">
