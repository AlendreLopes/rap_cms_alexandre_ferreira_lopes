...
<head>
	...
	<title>Teste de Supress&atilde;o 2 Doses RIA</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_teste_de_supressao_ii WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Teste de Supress&atilde;o 2 Doses RIA.
...
{	
	...
	<legend>Laudo de Teste de Supress&atilde;o 2 Doses RIA</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/endocrinologia/teste_de_supressao_ii_cadastrar.php" method="post">
