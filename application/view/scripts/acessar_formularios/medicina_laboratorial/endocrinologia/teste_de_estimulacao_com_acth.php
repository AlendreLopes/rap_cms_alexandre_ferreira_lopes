...
<head>
	...
	<title>Teste de Supress&atilde;o P&oacute;s-ACTH</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_e_teste_de_estimulacao_com_acth WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Teste de Supress&atilde;o P&oacute;-ACTH.
...
{	
	...
	<legend>Laudo de Teste de Supress&atilde;o P&oacute;-ACTH</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/endocrinologia/teste_de_estimulacao_com_acth_cadastrar.php" method="post">
