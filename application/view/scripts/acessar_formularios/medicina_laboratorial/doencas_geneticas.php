...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_doencas_geneticas WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Doen&ccedil;as Gen&eacute;ticas.
...
{	
	...
	<legend>Laudo de Doen&ccedil;as Gen&eacute;ticas</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/doencas_geneticas_cadastrar.php" method="post">
