...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_transcrever_exames WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado em Outros Exames.
...
{	
	...
	<legend>Outros Exames
    
	</legend><form id="formulario" action="/application/models/medicina_laboratorial/transcrever_exames_cadastrar.php" method="post">
