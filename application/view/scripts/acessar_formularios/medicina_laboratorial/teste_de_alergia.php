...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_teste_de_alergia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Teste de Alergia.
...
{	
	...
	<legend>Laudo de Teste de Alergia</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/teste_de_alergia_cadastrar.php" method="post">
