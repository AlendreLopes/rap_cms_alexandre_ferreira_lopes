...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_al_pericardio WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de AL Pericardio.
...
{	
	...
	<legend>Laudo de AL Pericardio</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/al_cavitarios/al_pericardio_cadastrar.php" method="post">
