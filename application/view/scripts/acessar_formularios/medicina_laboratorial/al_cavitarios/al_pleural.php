...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_al_pleural WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de AL Pleural.
...
{	
	...
	<legend>Laudo de AL Pleural</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/al_cavitarios/al_pleural_cadastrar.php" method="post">
