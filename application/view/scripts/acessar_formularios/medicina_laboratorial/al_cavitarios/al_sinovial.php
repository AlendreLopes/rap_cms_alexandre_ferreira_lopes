...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_al_sinovial WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de AL Sinoval.
...
{	
	...
	<legend>Laudo de AL Sinoval</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/al_cavitarios/al_sinovial_cadastrar.php" method="post">
