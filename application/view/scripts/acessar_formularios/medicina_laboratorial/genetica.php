...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_genetica WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Gen&eacute;tica.
...
{	
	...
	<legend>Laudo de Gen&eacute;tica</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/genetica_cadastrar.php" method="post">
