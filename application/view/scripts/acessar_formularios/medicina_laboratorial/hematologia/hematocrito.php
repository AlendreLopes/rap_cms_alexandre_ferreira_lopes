...
<head>
	...
	<title>Hemat&oacute;crito</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hematocrito WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Hemat&oacute;crito.
...
{	
	...
	<legend>Laudo de Hemat&oacute;crito</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/hematocrito_cadastrar.php" method="post">
