...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hemograma_equino WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Hemograma Equino.
...
{	
	...
	<fieldset>
<legend>Hemograma Equino</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/hemograma_equino_cadastrar.php" method="post">
