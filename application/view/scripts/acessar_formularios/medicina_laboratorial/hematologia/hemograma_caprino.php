...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hemograma_caprino WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Hemograma Caprino.
...
{	
	...
	<fieldset>
<legend>Hemograma Caprino</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/hemograma_caprino_cadastrar.php" method="post">
