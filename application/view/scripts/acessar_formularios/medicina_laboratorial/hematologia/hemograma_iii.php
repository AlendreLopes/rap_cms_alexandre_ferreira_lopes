...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hemograma_iii WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Hemograma III.
...
{	
	...
	<fieldset>
<legend>Hemograma III</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/hemograma_iii_cadastrar.php" method="post">
