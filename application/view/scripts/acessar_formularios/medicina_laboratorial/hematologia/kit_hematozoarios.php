...
<head>
	...
	<title>Kit Hematozo&aacute;rios</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_kit_hematozoarios WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Kit Hematozo&aacute;rios.
...
{	
	...
	<legend>Laudo de Kit Hematozo&aacute;rios</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/kit_hematozoarios_cadastrar.php" method="post">
