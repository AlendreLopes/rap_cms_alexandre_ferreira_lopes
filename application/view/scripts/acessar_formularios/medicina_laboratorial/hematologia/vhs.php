...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_vhs WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de VHS.
...
{	
	...
	<legend>Laudo de VHS</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/vhs_cadastrar.php" method="post">
