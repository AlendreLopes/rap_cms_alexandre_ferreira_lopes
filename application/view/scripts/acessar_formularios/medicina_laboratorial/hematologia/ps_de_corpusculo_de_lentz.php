...
<head>
	...
	<title>Corp&uacute;sculo de Lenz</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ps_de_corpusculo_de_lentz WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Corp&uacute;sculo de Lentz.
...
{	
	...
	<legend>Laudo de Corp&uacute;sculo de Lentz</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/ps_de_corpusculo_de_lentz_cadastrar.php" method="post">
