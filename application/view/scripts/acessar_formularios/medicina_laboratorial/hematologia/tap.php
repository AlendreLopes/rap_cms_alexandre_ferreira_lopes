...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_tap WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de TAP.
...
{	
	...
	<legend>Laudo de TAP</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/tap_cadastrar.php" method="post">
