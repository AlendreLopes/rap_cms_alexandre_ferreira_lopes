...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hemograma_ii WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Hemograma II.
...
{	
	...
	<legend>Laudo de Hemograma II</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/hemograma_ii_cadastrar.php" method="post">
