...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ps_de_hematozoarios_i WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de PS de Hematozo&aacute;rios.
...
{	
	...
	<legend>Laudo de PS de Hematozo&aacute;rios</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/ps_de_hematozoarios_i_cadastrar.php" method="post">
