...
<head>
	...
	<title>PS de Microfilarias</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ps_de_microfilarias WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de PS de Microfilarias.
...
{	
	...
	<legend>Laudo de PS de Microfilarias</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/ps_de_microfilarias_cadastrar.php" method="post">
