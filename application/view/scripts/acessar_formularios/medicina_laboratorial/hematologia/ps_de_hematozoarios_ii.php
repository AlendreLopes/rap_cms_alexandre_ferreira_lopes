...
<head>
	...
	<title>PS de Hematozo&aacute;rios</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ps_de_hematozoarios_ii WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de PS de Hematozo&aacute;rios Equino.
...
{	
	...
	<legend>Laudo de PS de Hematozo&aacute;rios Equino</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/ps_de_hematozoarios_ii_cadastrar.php" method="post">
