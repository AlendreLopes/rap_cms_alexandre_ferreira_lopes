...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_fibrogenio WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Fibrinog&ecirc;nio.
...
{	
	...
	<legend>Laudo de Fibrinog&ecirc;nio</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/fibrogenio_cadastrar.php" method="post">
