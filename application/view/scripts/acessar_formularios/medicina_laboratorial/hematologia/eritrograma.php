...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_eritrograma WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Eritrograma.
...
{	
	...
	<legend>Laudo de Eritrograma</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/eritrograma_cadastrar.php" method="post">
