...
<head>
	...
	<title>Contagem de Reticulocitos</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_contagem_de_reticulocitos WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Contagem de Reticulocitos.
...
{	
	...
	<legend>Laudo de Contagem de Reticulocitos</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/contagem_de_reticulocitos_cadastrar.php" method="post">
