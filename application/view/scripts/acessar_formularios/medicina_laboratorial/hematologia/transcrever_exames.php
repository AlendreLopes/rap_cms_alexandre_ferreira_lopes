...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_transcrever_exames WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
{	
	...
	<fieldset>
<legend>Transcrever Exames</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/transcrever_exames_cadastrar.php" method="post">
