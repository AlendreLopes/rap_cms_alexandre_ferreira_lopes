...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hemograma_ovino WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Hemograma Ovino.
...
{	
    ...
    <legend>Hemograma Ovino</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/hemograma_ovino_cadastrar.php" method="post">
