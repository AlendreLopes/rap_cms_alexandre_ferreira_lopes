...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_ttp WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de TTP.
...
{	
	...
	<legend>Laudo de TTP</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/ttp_cadastrar.php" method="post">
