...
<head>
	...
	<title>Contagem de Plaquetas</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_contagem_de_plaquetas WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Contagem de Plaquetas.
...
{	
	...
	<legend>Contagem de Plaquetas</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/contagem_de_plaquetas_cadastrar.php" method="post">
