...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_h_hemograma_i WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Hemograma I.
...
{	
	...
	<legend>Laudo de Hemograma I</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/hematologia/hemograma_i_cadastrar.php" method="post">
