...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_m_cultura_fungica WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Microbiologia Cultura F&uacute;ngica.
...
{	
	...
	<legend>Laudo de Microbiologia F&uacute;ngica</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/microbiologia/cultura_fungica_cadastrar.php" method="post">
