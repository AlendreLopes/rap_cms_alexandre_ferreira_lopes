...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_m_cultura WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Microbiologia Cultura e Antibiograma.
...
{	
	...
	<legend>Laudo de Microbiologia Cultura e Antibiograma</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/microbiologia/cultura_cadastrar.php" method="post">
	...
	Antibiograma
        ...
        <textarea name="c_4">CULTURA E ANTIBIOGRAMA
