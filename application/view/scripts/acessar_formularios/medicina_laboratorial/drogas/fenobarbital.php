...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_dg_fenobarbital WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Fenobarbital.
...
{	
	...
	<legend>Laudo de Fenobarbital</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/drogas/fenobarbital_cadastrar.php" method="post">
