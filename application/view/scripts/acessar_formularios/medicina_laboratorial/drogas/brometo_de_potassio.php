...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_dg_brometo_de_potassio WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Brometo de Pot&aacute;ssio.
...
{	
	...
	<legend>Laudo de Brometo de Pot&aacute;ssio</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/drogas/brometo_de_potassio_cadastrar.php" method="post">
