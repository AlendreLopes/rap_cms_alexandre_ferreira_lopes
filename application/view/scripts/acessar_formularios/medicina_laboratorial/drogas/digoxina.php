...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_dg_digoxina WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Digoxina.
...
{	
	...
	<legend>Laudo de Digoxina</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/drogas/digoxina_cadastrar.php" method="post">
    ...
    <textarea name="c_3">Concentra&ccedil;&otilde;es acima de 2,6 a 3,0 ng/mL se associaram com uma probabilidade crescente de toxicidade.</textarea>
