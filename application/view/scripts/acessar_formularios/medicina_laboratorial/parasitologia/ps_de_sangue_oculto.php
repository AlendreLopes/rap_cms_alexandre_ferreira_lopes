...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_p_ps_de_sangue_oculto WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de PS de Sangue Oculto.
...
{	
	...
	<legend>Laudo de PS de Sangue Oculto</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/parasitologia/ps_de_sangue_oculto_cadastrar.php" method="post">
