...
<head>
	...
	<title>Transcrever Exames</title>
...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_p_transcrever_exames WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Transcri&ccedil;&atilde;o de Exames.
...
{	
	...
	<legend>Laudo de Transcri&ccedil;&atilde;o de Exames</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/parasitologia/transcrever_exames_cadastrar.php" method="post">
