...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_p_parasitologia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Parasitologia.
...
{	
	...
	<legend>Laudo de Parasitologia</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/parasitologia/parasitologia_cadastrar.php" method="post">
