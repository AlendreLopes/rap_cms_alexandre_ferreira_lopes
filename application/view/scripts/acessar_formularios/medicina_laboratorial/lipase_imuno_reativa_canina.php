...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_lipase_imuno_reativa_canina WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Lipase Imuno Reativa Canina.
...
{	
	...
	<legend>Laudo de Lipase Imuno Reativa Canina</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/lipase_imuno_reativa_canina_cadastrar.php" method="post">
