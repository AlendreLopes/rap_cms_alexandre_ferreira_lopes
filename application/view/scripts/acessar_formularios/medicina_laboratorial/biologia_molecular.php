...
$Laudo  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ml_biologia_molecular WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
if($Laudos)
{
	...
	<strong>
		...
		J&aacute; cadastrado nos Laudos de Biologia Molecular.
...
{	
	...
	<legend>Laudo de Biologia Molecular</legend>
	
	<form id="formulario" action="/application/models/medicina_laboratorial/biologia_molecular_cadastrar.php" method="post">
