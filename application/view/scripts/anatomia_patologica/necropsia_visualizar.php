...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ap_necropsia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ap_necropsia");
...
<div id="usuario">
	...
	<div id="titulo">
	[ <a href="<?php echo $url_n;?>" title="<?php echo $paginas;?>">Voltar</a> ]
	</div>
...
<fieldset>
	...
	<legend align="center">Laudo Necropsia</legend>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_amostra"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_amostra]);?></span></span>
	
	</label>
	
	<label class="mensagem">
	
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_exame"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_exame]);?></span></span>
	...
	<?php
        ...
        $imagem = $SQL -> Consultar("SELECT * FROM tb_imagens WHERE imagem_necropsia = '{$Exame[_id]}' ORDER BY imagem_id ASC");
        ...
        if($retorno)
        {
            ...
            echo "<a href=\"".LMPaginas::Imagem('necropsia_imagens',$Exame[protocolo_id],$Exame[_id])."\" title=\"Imagens\">Adicionar Imagens</a>";
            ...
            while($imagens = mysql_fetch_array($imagem))
            {
                ...
                echo "<a href=\"".LMPaginas::Imagem('necropsia_imagem_editar',$Exame[protocolo_id],$imagens[imagem_id])."\" id=\"T\" title=\"Trocar Imagem\">Trocar</a>";
        ...
        else
        {
            echo "<label class=\"linha_img\">\n";
                ...
                echo "<a href=\"".LMPaginas::Imagem('necropsia_imagens',$Exame[protocolo_id],$Exame[_id])."\" title=\"Imagens\">Cadastrar Imagens</a>";
