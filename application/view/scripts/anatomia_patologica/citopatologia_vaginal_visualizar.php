...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ap_citopatologia_vaginal WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ap_citopatologia_vaginal");
...
<head>
	...
	$(document).ready(function(){
		...
		var t_t   = "laudos_ap_citopatologia_vaginal";
		var c_i   = "_id";
	...
	<link type="text/css" rel="stylesheet" media="screen" href="/public/styles/sistema_thickbox.css" />
...
<fieldset>
	...
	<legend align="center">Laudo Citopatol&oacute;gico Vaginal</legend>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_codigo"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_codigo];?></span></span>
	...
	-->
        ...
        <label class="linha">
            ...
            <span class="e_" numero="<?php echo $Numero;?>" celula="_epiteliais_queratinizadas"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_epiteliais_queratinizadas];?></span></span>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_epiteliais_queratinizadas_n"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_epiteliais_queratinizadas_n];?></span></span>
	...
	<span class="e_" numero="<?php echo $Numero;?>" celula="_bacterias"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_bacterias];?></span></span>
    ...
    <label class="linha">
        ...
        <span class="e_" numero="<?php echo $Numero;?>" celula="_em_branco"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_em_branco];?></span></span>

    </label>
    
    <label>

        <strong>Em Branco Resultado</strong>

        <span class="e_" numero="<?php echo $Numero;?>" celula="_em_branco_"><span class="e_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_em_branco_];?></span></span>

    </label>
    
    <label class="mensagem">
	
	<strong>Diagn&oacute;stico(s)</strong>
	
	<span class="ed_" numero="<?php echo $Numero;?>" celula="_diagnostico"><span class="ed_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo nl2br($Exame[_diagnostico]);?></span></span>
    ...
    <div id="img_listar">
        ...
        $imagem = $SQL -> Consultar("SELECT * FROM tb_imagens WHERE imagem_citopatologia_vaginal = '$Exame[_id]' ORDER BY imagem_id ASC");
        ...
        if($retorno)
        {
            ...
            echo "<a href=\"".LMPaginas::Imagem('citopatologia_vaginal_imagens',$Exame[protocolo_id],$Exame[_id])."\" title=\"Imagens\">Adicionar Imagens</a>";
            ...
            while($imagens = mysql_fetch_array($imagem))
            {
                ...
                echo "<a href=\"".LMPaginas::Imagem('citopatologia_vaginal_imagem_editar',$Exame[protocolo_id],$imagens[imagem_id])."\" id=\"T\" title=\"Trocar Imagem\">Trocar</a>";
        ...
        else
        {
            echo "<label class=\"linha_img\">\n";
                ...
                echo "<a href=\"".LMPaginas::Imagem('citopatologia_vaginal_imagens',$Exame[protocolo_id],$Exame[_id])."\" title=\"Imagens\">Cadastrar Imagens</a>";
