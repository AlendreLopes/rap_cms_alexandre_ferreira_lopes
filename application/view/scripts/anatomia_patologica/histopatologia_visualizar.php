...
$Exames  = $SQL -> Consultar("SELECT * FROM protocolos, laudos_ap_histopatologia WHERE protocolo_id = '$indice' AND _laudo = '$indice'");
...
$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE protocolos, laudos_ap_histopatologia");
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var t_t   = "laudos_ap_histopatologia";
			var c_i   = "_id";
...
<fieldset>
	...
	<legend align="center">Laudo Histopatol&oacute;gico</legend>
	...
	<label class="linha">
        ...
        $imagem = $SQL -> Consultar("SELECT * FROM tb_imagens WHERE imagem_histopatologia = '$Exame[_id]' ORDER BY imagem_id ASC");
        ...
        if($retorno)
        {
            ...
            echo "<a href=\"".LMPaginas::Imagem('histopatologia_imagens',$Exame[protocolo_id],$Exame[_id])."\" title=\"Imagens\">Adicionar Imagens</a>";
            ...
            while($imagens = mysql_fetch_array($imagem))
            {
                ...
                echo "<a href=\"".LMPaginas::Imagem('histopatologia_imagem_editar',$Exame[protocolo_id],$imagens[imagem_id])."\" id=\"T\" title=\"Trocar Imagem\">Trocar</a>";
        ...
        else
        {
            echo "<label class=\"linha_img\">\n";
                ...
                echo "<a href=\"".LMPaginas::Imagem('histopatologia_imagens',$Exame[protocolo_id],$Exame[_id])."\" title=\"Imagens\">Cadastrar Imagens</a>";
