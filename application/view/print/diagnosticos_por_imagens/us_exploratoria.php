<div class="corpo">
	...
	<tr>
	<th colspan="8">ULTRA-SONOGRAFIA ABDOMINAL EXPLORAT&Oacute;RIA</th>
	</tr>
	...
	<tr>
            <th colspan="8" align="right"><img src="http://reports.petimagem.com.br/public/image/assinaturas/danielle.jpg" alt="Drª Danielle" width="200" height="120" /></th>
        </tr>
    ...
    if($listar[_descricao] != 'Meketrefe')
    {
        ?>
            ...
            <tr>
            <td colspan="8" align="justify"><?php echo nl2br($listar[_descricao]);?></td>
            </tr>
        <?php
    }
    ?>
