...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	{
            ?>
            <tr><td colspan="8"><strong>Amostra</strong></td></tr>
            <tr>
            <td colspan="8" align="justify"><?php echo nl2br($listar[_amostra]);?></td>
            </tr>
            <tr>
            <td colspan="8">&nbsp;</td>
            </tr>
	...
	if($listar[_exame] != 'Meketrefe')
	{
            ?>
            <tr>
            <td colspan="8" align="justify"><?php echo nl2br($listar[_exame]);?></td>
            </tr>
            <tr>
            <td colspan="8">&nbsp;</td>
            </tr>
	...
	if($listar[_conclusao] != 'Meketrefe')
	{
            ...
            <tr>
            <td colspan="8" align="justify"><?php echo nl2br($listar[_conclusao]);?></td>
            </tr>
            <?php
	}
	?>
...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">NECROPSIA IMAGENS</th>
	</tr>
