		...
		<table width="840" border="0" cellpadding="0" cellspacing="0">
			...
			<thead>
				...
				<tr>
					...
					<th colspan="3" align="left"><span class="no_bold"><?php echo $Lista[_protocolo]; ?></span></th>
			...
			<tfoot>
				...
				<tr>
					<th colspan="8" align="right"><img
							src="http://reports.petimagem.com.br/public/image/assinaturas/danielle.jpg"
							alt="Dr&ordf; Danielle" title="Drª Danielle Tullio Murad" width="150" height="120" /></th>
				</tr>
				<tr>
					<th colspan="8" align="center" class="textoM">
						&ldquo;O presente resultado tem seu valor restrito &agrave; amostra examinada neste
						laborat&oacute;rio .&rdquo; </th>
				</tr>
				<tr>
					<th colspan="8">&nbsp;</th>
				</tr>
				...
				*/
				if ($listar[_amostra] != 'Meketrefe') {
					...
					<tr>
						...
						<td colspan="7"><?php echo $listar[_amostra]; ?></td>
					</tr>
					<tr>
						<td colspan="8">&nbsp;</td>
					</tr>
		...
		<div class="conteudo">
			...
			<table width="840" border="0" cellpadding="0" cellspacing="0">
				...
				<thead>
					...
					<tr>
						<th colspan="8">CITOPATOLOGIA IMAGENS</th>
					</tr>
