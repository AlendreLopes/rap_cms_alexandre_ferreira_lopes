<div class="corpo">
    ...
    <tr><th colspan="3">NECROPSIA</th></tr>
	...
	<td width="760" colspan="2"><?php echo $listar[_codigo];?></td>
	</tr>
	<tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
	...
	<tr>
	  <td colspan="3" align="justify"><?php echo nl2br($listar[_amostra]);?></td>
	</tr>
	<?php
	}
	?>
	...
	?>
	<tr>
	<td colspan="3" align="justify"><?php echo nl2br($listar[_exame]);?></td>
	</tr>
	<?php
	}
	?>
	...
	<tr>
	<td colspan="3" align="justify"><?php echo nl2br($listar[_conclusao]);?></td>
	</tr>
	<?php
	}
	?>
...
$imagem   = $SQL -> Consultar("SELECT * FROM tb_imagens WHERE imagem_necropsia = '{$listar[_id]}'");
