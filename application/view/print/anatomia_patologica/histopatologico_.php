<div class="corpo">
	...
	<tr>
	<th colspan="2">HISTOPATOLOGIA</th>
	</tr>
	<tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td width="760"><?php echo $listar[_codigo];?></td>
    </tr>
	<tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
	...
	<td><?php echo $listar[_amostra];?></td>
	</tr>
	<?php
	}
	?>
	...
	?>
	<tr>
	<td colspan="2" align="justify"><?php echo nl2br($listar[_exame]);?></td>
	</tr>
	<?php
	}
	?>
	...
	?>
	<tr>
	<td colspan="2"><strong>Diagn&oacute;stico(s)</strong></td>
	</tr>
	<tr>
	<td colspan="2" align="justify"><?php echo nl2br($listar[_conclusao]);?></td>
	</tr>
	<?php
	}
	?>
	...
	<tr>
	<td>&nbsp;</td>
	<td align="right"><img src="http://reports.petimagem.com.br/public/image/assinaturas/silvana.jpg" alt="Dr&ordf; Silvana" width="150" height="120" /></td>
	</tr>
	<tr>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
...
$imagem   = $SQL -> Consultar("SELECT * FROM tb_imagens WHERE imagem_histopatologia = '{$listar[_id]}'");
