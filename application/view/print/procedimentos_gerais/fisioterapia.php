...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	?>
		...
		<tr>
		<td colspan="8" align="justify"><?php echo nl2br($listar[_relatorio]); ?></td>
		</tr>
        <tr>
          <td colspan="8">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="5">&nbsp;</td>
          <td colspan="3"><?php echo $listar[_autor];?></td>
        </tr>
        <tr>
          <td colspan="5">&nbsp;</td>
          <td colspan="3"><?php echo $listar[_crmv];?></td>
        </tr>
        <tr>
	<?php
	}
