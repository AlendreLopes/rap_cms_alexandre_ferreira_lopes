...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8"><strong>COPROL&Oacute;GICO FUNCIONAL</strong></th>
	</tr>
	...
	<td colspan="7" class="textoM"><em>Gelatina de Knox e Sudam III</em></td>
	</tr>
	<tr>
	<td colspan="8"><strong>Resultado:</strong></td>
	</tr>
	<?php
	if($listar[_tripsina] != 'Meketrefe')
	{
		?>
		<tr>
		<td>&nbsp;</td>
		<td><strong>Tripsina fecal:</strong></td>
		<td colspan="6"><?php echo $listar[_tripsina];?></td>
		</tr>
		<?php
	}
	if($listar[_fibras] != 'Meketrefe')
	{
		?>
		<tr>
		<td>&nbsp;</td>
		<td><strong>Fibras musculares:</strong></td>
		<td colspan="6"><?php echo $listar[_fibras];?></td>
		</tr>
		<?php
	}
	if($listar[_amido] != 'Meketrefe')
	{
		?>
		<tr>
		<td>&nbsp;</td>
		<td><strong>Amido:</strong></td>
		<td colspan="6"><?php echo $listar[_amido];?></td>
		</tr>
		<?php
	}
	...
	if($listar[_gordura_fecal] != 'Meketrefe')
	{
		?>
		<tr>
		<td>&nbsp;</td>
		<td><strong>Gordura Fecal:</strong></td>
		<td colspan="6"><?php echo $listar[_gordura_fecal];?></td>
		</tr>
		<?php
	}
	...
	?>
		...
		<tr>
		<td colspan="8" class="textoM">Para a correta interpreta&ccedil;&atilde;o dos Resultados, observar a dieta fornecida ao paciente antes da coleta das fezes.</td>
		</tr>
	<?php
	}
	...
	?>
		...
		<tr>
		<td colspan="8" align="justify"><?php echo nl2br($listar[_resultado]);?></td>
		</tr>
        <tr>
        <td colspan="8" class="textoM">Para a correta interpreta&ccedil;&atilde;o dos Resultados, observar a dieta fornecida ao paciente antes da coleta das fezes.</td>
        </tr>
