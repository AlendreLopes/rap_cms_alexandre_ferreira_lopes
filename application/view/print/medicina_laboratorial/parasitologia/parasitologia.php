...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8"><strong>PARASITOL&Oacute;GICO DE OUVIDO</strong></th>
	</tr>
	...
	<td colspan="7" class="textoM"><em>Secre&ccedil;&atilde;o seb&aacute;cea</em></td>
	</tr>
	<tr>
	<td class="textoM"><strong>M&eacute;todos:</strong></td>
	<td colspan="7" class="textoM"><em>Direto e Corado</em></td>
	</tr>
	<tr>
	<td colspan="8"><strong>Resultado:</strong></td>
	</tr>
	<?php
	if($listar[_otodectes] != 'Meketrefe')
	{
		?>
		<tr>
		<td>&nbsp;</td>
		<td><strong><em>Otodectes sp.</em>:</strong></td>
		<td colspan="6"><?php echo $listar[_otodectes];?></td>
		</tr>
		<?php
	}
	if($listar[_malassezia] != 'Meketrefe')
	{
		?>
		<tr>
		<td>&nbsp;</td>
		<td><strong><em>Malassezia sp.</em>:</strong></td>
		<td colspan="6"><?php echo $listar[_malassezia];?></td>
		</tr>
		<?php
	}
