...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8"><strong>LIPASE IMUNO REATIVA CANINA</strong></th>
	</tr>
	...
	<tr>
	    ...
	    <td colspan="7" class="textoM"><em>sangue total  ou soro</em></td>
	</tr>
	<tr>
	    <td class="textoM"><strong>M&eacute;todo:</strong></td>
	    <td colspan="7" class="textoM"><em>Ensaio cromatogr&aacute;fico (tipo SNAP) qualitativo  baseado em ELISA</em>.</td>
	</tr>
	<?php
	...
	?>
		...
		<td><?php echo nl2br($listar[_resultado]); ?></td>
		<td colspan="6">&nbsp;</td>
		</tr>
        <tr>
          <td colspan="2">&nbsp;</td>
          <td colspan="6" class="textoM"><strong>Valores de Refer&ecirc;ncia</strong></td>
        </tr>
        <tr>
        <td colspan="2">&nbsp;</td>
        <td colspan="6" class="textoM">
        Normal - investigar as doen&ccedil;as intestinais, renais ou hep&aacute;ticas
        <br />
        Anormal - sugestivo de Pancreatite
        <!--
        3 escalas de Scores:
        <br />
        1 - &lt;ou = a 200 mcg/L - NORMAL: Investigar  doen&ccedil;as intestinais, renais ou hep&aacute;ticas;
        <br />
        2 - 201 a 399 mcg/L - Concentra&ccedil;&atilde;o elevada. Pode  ou n&atilde;o ter pancreatite;
        <br />
        3 - &gt;ou = 400 mcg/L - Concentra&ccedil;&atilde;o consistente com pancreatite.
        -->
        </td>
        </tr>
