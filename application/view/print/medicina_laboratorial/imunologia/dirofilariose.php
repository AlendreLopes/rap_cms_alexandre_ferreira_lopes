...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">DIROFILARIA / ERLICHIA / BORRELIA / ANAPLASMA</th>
	</tr>
	...
	<td colspan="7" class="textoM"><em>Sangue total</em></td>
	</tr>
	<tr>
    <td class="textoM"><strong>M&eacute;todo:</strong></td>
    <td colspan="7" class="textoM"><em>Snap Test (IDEXX Laboratories)</em></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td><strong>Dirofilaria immitis</strong>:</td>
	  <td colspan="6"><strong><?php echo $listar[_dirofilaria];?></strong></td>
	  </tr>
	<tr>
	<td>&nbsp;</td>
	<td><strong>Ehrlichia canis</strong>:</td>
	<td colspan="6"><strong><?php echo $listar[_ehrlichia];?></strong></td>
	</tr>
	<tr>
	<td>&nbsp;</td>
	<td><strong>Borrelia burgdorferi</strong>:</td>
	<td colspan="6"><strong><?php echo $listar[_borrelia];?></strong></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td><strong>Anaplasma phagocytophilum</strong></td>
	  <td colspan="6"><strong><?php echo $listar[_anaplasma];?></strong></td>
	  </tr>
