...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<?php
	if($listar[_ifa] != 'Meketrefe')
	{
	?>
		<tr>
		<td colspan="8" align="center"><strong>CINOMOSE IFA</strong></td>
		</tr>
		<tr>
		<td colspan="8" class="textoM"><strong>Amostra:</strong> <em>Soro e Sangue Total</em></td>
		</tr>
		<tr>
		<td colspan="8" class="textoM"><strong>M&eacute;todo:</strong> <em>Imunofluoresc&ecirc;ncia indireta (IFA)</em></td>
		</tr>
		<tr>
		<td><strong>Resultado:</strong></td>
		<td colspan="7"><?php echo nl2br($listar[_ifa]);?></td>
		</tr>
		<tr>
		<td>&nbsp;</td>
		<td colspan="8" class="textoM" align="justify">
        <strong>Valores de refer&ecirc;ncia:</strong>
        <br />
        IgG maior ou igual  1:50 &ndash; evid&ecirc;ncia de imuniza&ccedil;&atilde;o ou contato viral anterior;
        <br />
		IgG maior ou igual 1:50 e IgM maior ou igual 1:25 &ndash; recente imuniza&ccedil;&atilde;o ou recente infec&ccedil;&atilde;o;
        <br />
		IgM maior ou igual 1:25 e com sinais cl&iacute;nicos &ndash; infec&ccedil;&atilde;o;
        <br />
		IgM menor que 1:25 e IgG menor que 1:50, pesquisa viral negativa e com sinais cl&iacute;nicos &ndash; colher nova amostra ap&oacute;s 10 dias.
        </td>
		</tr>
		<tr>
		<td colspan="8">&nbsp;</td>
	...
	if($listar[_direta] != 'Meketrefe')
	{
	?>
		<tr>
		<td colspan="8" align="center"><strong>CINOMOSE IFD</strong></td>
		</tr>
		<tr>
		<td colspan="8" class="textoM"><strong>M&eacute;todo:</strong> <em>Imunofluoresc&ecirc;ncia direta</em></td>
		<tr>
		<td><strong>Resultado:</strong></td>
		<td colspan="7"><?php echo nl2br($listar[_direta]);?></td>
		</tr>
		<tr>
		<td>&nbsp;</td>
        <td colspan="7" class="textoM"><strong>Valores de refer&ecirc;ncia:</strong><br />Negativo</td>
		</tr>
	...
	?>
		<tr>
		<td colspan="8" align="justify"><strong>Observa&ccedil;&atilde;o:</strong></td>
		</tr>
		<tr>
