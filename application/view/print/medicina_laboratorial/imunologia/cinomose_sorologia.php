...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">CINOMOSE SOROLOGIA</th>
	</tr>
	...
	?>
		...
		<td colspan="7"><?php echo $listar[_resultado];?></td>
		</tr>
		<tr>
		<td>&nbsp;</td>
		<td colspan="7" class="textoM"><strong>Valor de refer&ecirc;ncia:</strong><br /> Negativo</td>
		</tr>
		<tr>
		<td colspan="8" class="textoM" align="justify"><strong>Nota:</strong><br />Pode-se detectar o v&iacute;rus ap&oacute;s cont&aacute;gio em prazo inicial de 3 dias (quando ocorre a viremia) em amostras de soro ou plasma e de 3 a 6 dias  em amostras de secre&ccedil;&otilde;es oculares (quando ocorre a multiplica&ccedil;&atilde;o dentro das c&eacute;lulas). Resultado positivo: indica a presença de ant&iacute;geno da cinomose na amostra testada. A detec&ccedil;&atilde;o do v&iacute;rus ocorre a partir do terceiro dia de infec&ccedil;&atilde;o. O teste não possui influência sobre a vacina DHPPL de 1 a 14 dias ap&oacute;s a vacina&ccedil;&atilde;o devido ao fato de a titula&ccedil;&atilde;o do v&iacute;rus na vacina ser muito baixa.</td>
		</tr>
