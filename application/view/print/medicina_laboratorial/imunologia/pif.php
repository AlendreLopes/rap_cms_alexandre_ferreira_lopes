...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">PERITONITE INFECCIOSA FELINA (PIF)</th>
	</tr>
	...
	<td colspan="7" class="textoM"><em>Immunocomb - Avalia&ccedil;&atilde;o Imunológica</em></td>
	</tr>
	<tr>
	  <td><strong>Resultado:</strong></td>
	  <td colspan="7"><strong><?php echo $listar[_resultado];?></strong></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td colspan="7">
	    ...
	    Negativo
	    <br />
	    - score 0 &nbsp; &nbsp; &nbsp; : baixa imunidade
	    <br />
	    - score 1 a 3: m&eacute;dia imunidade
	    <br />
	    - score 4 e 5: alta imunidade
	    <br />
	    - score maior ou igual a 6
	    <br />
	    Score 0 &nbsp; &nbsp; &nbsp; : negativo
	    <br />
	    Score 1 e 2: baixo positivo &nbsp;. Poss&iacute;vel est&aacute;gio inicial ou convalescente de corona v&iacute;rus/ pode ser n&atilde;o espec&iacute;fico.
	    <br />
	    Score 3 e 4: m&eacute;dio positivo. Pr&eacute;via indica&ccedil;&atilde;o ou infec&ccedil;&atilde;o corrente por corona virus.
	    <br />
	    Score 5 e 6: Alto positivo &nbsp; &nbsp; . Indicativo de infec&ccedil;&atilde;o por corona v&iacute;rus/ compat&iacute;vel com diagn&oacute;stico de PIF.</td>
	  </tr>
	<?php
