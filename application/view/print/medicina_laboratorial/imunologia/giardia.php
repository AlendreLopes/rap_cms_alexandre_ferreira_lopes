...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">GI&Aacute;RDIA</th>
	</tr>
	...
	<td colspan="7" class="textoM"><em>Imunoensaio enzim&aacute;tico</em></td>
	</tr>
	<tr>
	<td><strong>Resultado</strong>:</td>
	<td colspan="7"><?php echo $listar[_giardia];?></td>
	</tr>
	<tr>
	<td colspan="2">&nbsp;</td>
	<td colspan="6" class="textoM"><strong>Valor de refer&ecirc;ncia</strong>: <br />Negativo</td>
	</tr>
