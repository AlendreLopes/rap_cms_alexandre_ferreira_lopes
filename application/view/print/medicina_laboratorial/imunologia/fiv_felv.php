...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	  ...
	  <td colspan="7" class="textoM"><em><?php echo $listar[_amostra];?></em></td>
	  </tr>
	<tr>
	<td class="textoM"><strong>M&eacute;todo:</strong></td>
        <td colspan="7" class="textoM"><em>Imunomigra&ccedil;&atilde;o r&aacute;pida (RIM&TRADE;)</em></td>
	</tr>
	<tr>
	<td colspan="8"><strong>IMUNODEFICIENCIA VIRAL FELINA - FIV</strong></td>
	</tr>
	<tr>
	<td>&nbsp;</td>
	<td><strong>Resultado</strong>: <?php echo $listar[_fiv];?></td>
	<td colspan="6" class="textoM"><strong>Valor de refer&ecirc;ncia:</strong></td>
	</tr>
	<tr>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td colspan="6" class="textoM">Negativo</td>
	</tr>
	<tr>
	<td colspan="8"><strong>LEUCEMIA VIRAL FELINA - FELV</strong></td>
	</tr>
	<tr>
	<td>&nbsp;</td>
	<td><strong>Resultado</strong>: <?php echo $listar[_felv];?></td>
	<td colspan="6" class="textoM"><strong>Valor de refer&ecirc;ncia:</strong></td>
	</tr>
	<tr>
	<td>&nbsp;</td>
