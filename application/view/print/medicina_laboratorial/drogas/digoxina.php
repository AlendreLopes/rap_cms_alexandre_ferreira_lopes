...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	?>
		...
		<td align="left"><?php echo $listar[_resultado]; ?></td>
		<td colspan="6" align="left"><strong>ng/mL</strong></td>
		</tr>
		<tr>
		  <td colspan="2">&nbsp;</td>
		  <td class="textoM"><strong>Canino:</strong></td>
		  <td colspan="5" class="textoM"><em>1,0 a 2,5</em></td>
	    </tr>
		<tr>
		<td colspan="2">&nbsp;</td>
		<td class="textoM"><strong>Felino:</strong></td>
		<td colspan="5" class="textoM"><em>0,8 a 2,0</em></td>
		</tr>
		<tr>
		<td colspan="8">&nbsp;</td>
		</tr>
