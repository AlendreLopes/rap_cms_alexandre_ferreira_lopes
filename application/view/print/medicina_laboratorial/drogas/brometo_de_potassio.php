...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">BROMETO DE POT&Aacute;SSIO</th>
	</tr>
	...
	?>
        ...
        <td colspan="7" class="textoM"><em><?php echo $listar[_metodo]; ?></em></td>
        </tr>
        <tr>
		<td><strong>Resultado:</strong></td>
		<td><?php echo $listar[_resultado]; ?></td>
		<td><strong>mg/dL</strong></td>
		<td colspan="5">&nbsp;</td>
		</tr>
		<tr>
		  <td colspan="2">&nbsp;</td>
		  <td class="textoM"><strong>Subterap&ecirc;utico:</strong></td>
		  <td colspan="5" class="textoM"><em>menor que 200 mg/dL</em></td>
	    </tr>
		<tr>
		  <td colspan="2">&nbsp;</td>
		  <td class="textoM"><strong>Terap&ecirc;utico:</strong></td>
		  <td colspan="5" class="textoM"><em><em>200 a 300 mg/dL</em></em></td>
	    </tr>
		<tr>
		<td colspan="2">&nbsp;</td>
        <td class="textoM"><strong>T&oacute;xico:</strong></td>
        <td colspan="5" class="textoM"><em><em><em>maior que 400 mg/dL</em> </em></em></td>
        </tr>
