...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="9">HEMOGRAMA BOVINO</th>
	</tr>
	...
	?>
		...
		?>
			...
			<td colspan="3" align="center" class="textoM">5 a 10</td>
			<td colspan="2">&nbsp;</td>
			</tr>
		<?php
		}
		...
		?>
			...
			<td colspan="3" align="center" class="textoM">8 a 14</td>
			<td colspan="2">&nbsp;</td>
			</tr>
		<?php
		}
		...
		?>
			...
			<td colspan="3" align="center" class="textoM">24 a 46</td>
			<td colspan="2">&nbsp;</td>
			</tr>
		<?php
		}
		...
		?>
			...
			<td colspan="3" align="center" class="textoM">40 a 60</td>
			<td colspan="2">&nbsp;</td>
			</tr>
		<?php
		}
		...
		?>
			...
			<td colspan="3" align="center" class="textoM">11 a 17</td>
			<td colspan="2">&nbsp;</td>
			</tr>
		<?php
		}
	...
	?>
		...
		?>
			...
			<td colspan="3" align="center" class="textoM">4.000 a 12.000</td>
			<td colspan="2">&nbsp;</td>
			</tr>
			<tr>
			...
			?>
				...
				<td colspan="3" align="center" class="textoM">200 a 1.500</td>
				<td colspan="2">&nbsp;</td>
				</tr>
			<?php
			}
			...
			?>
				...
				<td colspan="3" align="center" class="textoM">3.000 a 7.500</td>
				<td colspan="2">&nbsp;</td>
				</tr>
			<?php
			}
			...
			?>
				...
				<td colspan="3" align="center" class="textoM">100 a 850</td>
				<td colspan="2">&nbsp;</td>
				</tr>
			<?php
			}
			...
			?>
				...
				<td colspan="3" align="center" class="textoM">0 a 200</td>
				<td colspan="2">&nbsp;</td>
				</tr>
			<?php
			}
			...
			?>
				...
				<td colspan="3" align="center" class="textoM">1.500 a 4.000</td>
				<td colspan="2">&nbsp;</td>
				</tr>
			<?php
			}
		...
		?>
			...
			<td colspan="3" align="center" class="textoM">7,0 a 9,0</td>
			<td colspan="2">&nbsp;</td>
			</tr>
		<?php
		}
		...
		?>
			...
			<td><strong>g/dL</strong></td>
			<td colspan="3" align="center" class="textoM">300 a 700</td>
			<td colspan="2">&nbsp;</td>
			</tr>
			<tr><td colspan="9">&nbsp;</td></tr>
		<?php
