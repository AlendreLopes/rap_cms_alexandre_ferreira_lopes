...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="9">VELOCIDADE DE HEMOSSEDIMENTA&Ccedil;&Atilde;O (VHS)</th>
	</tr>
	...
	<?php
	if($listar[_vhs] != 'Meketrefe')
	{
		?>
        <tr>
        <td class="textoM"><strong>M&eacute;todo:</strong></td>
        <td colspan="8" class="textoM"><em>Pipeta de Westergreen</em></td>
        </tr>
		<tr>
		<td>&nbsp;</td>
		<td><strong>VHS:</strong></td>
		<td><?php echo $listar[_vhs];?></td>
