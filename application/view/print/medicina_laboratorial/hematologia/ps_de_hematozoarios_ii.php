...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">PESQUISA DE HEMATOZO&Aacute;RIOS EQUINO</th>
	</tr>
	...
	?>
		...
		if ($listar[_mycoplasma] != 'Meketrefe')
		{
			...
			<tr>
			<td>&nbsp;</td>
			<td><strong><em>Babesia caballi</em>:</strong></td>
			<td colspan="6"><?php echo $listar[_mycoplasma];?></td>
			</tr>
			<?php
		}
		if ($listar[_ehrlichia] != 'Meketrefe')
		{
			...
			<tr>
			<td>&nbsp;</td>
			<td><strong>Theileria equi:</strong></td>
			<td colspan="6"><?php echo $listar[_ehrlichia];?></td>
			</tr>
			<?php
		}
		if ($listar[_babesia] != 'Meketrefe')
		{
			...
			<tr>
			<td>&nbsp;</td>
			<td><strong>Ehrlichia equi:</strong></td>
			<td colspan="6"><?php echo $listar[_babesia];?></td>
			</tr>
			<?php
		}
		?>
