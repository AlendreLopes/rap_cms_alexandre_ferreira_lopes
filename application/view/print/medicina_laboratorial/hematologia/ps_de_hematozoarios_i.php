...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">PESQUISA DE HEMATOZO&Aacute;RIOS</th>
	</tr>
		...
		)
	{
		...
		if ($listar[_mycoplasma] != 'Meketrefe')
		{
			...
			<tr>
			<td align="left">&nbsp;</td>
			<td align="left"><strong><em>Mycoplasma sp.</em>:</strong></td>
			<td colspan="6" align="left"><strong><?php echo $listar[_mycoplasma];?></strong></td>
			</tr>
			<?php
		}
		if ($listar[_ehrlichia] != 'Meketrefe')
		{
			...
			<tr>
			<td align="left">&nbsp;</td>
			<td align="left"><strong><em>Ehrlichia sp.</em>:</strong></td>
			<td colspan="6" align="left"><strong><?php echo $listar[_ehrlichia];?></strong></td>
			</tr>
			<?php
		}
		if ($listar[_babesia] != 'Meketrefe')
		{
			...
			<tr>
			<td align="left">&nbsp;</td>
			<td align="left"><strong><em>Babesia sp.</em>:</strong></td>
			<td colspan="6" align="left"><strong><?php echo $listar[_babesia];?></strong></td>
			</tr>
			<?php
		}
		?>
	...
	if ($listar[_outros] != 'Meketrefe')
	{
		...
		<tr>
		<td colspan="8" align="justify"><?php echo nl2br($listar[_outros]);?></td>
		</tr>
		<tr><td colspan="8">&nbsp;</td></tr>
		<?php
	}
	if ($listar[_observacao] != 'Meketrefe')
	{
		?>
		<tr>
		<td colspan="8" align="left"><strong>Observa&ccedil;&atilde;o:</strong></td>
		</tr>
		<tr>
