...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">TOXICOL&Oacute;GICO COMPLETO</th>
	</tr>
	...
	{
		?>
		<td valign="top" class="textoM"><strong>Amostra:</strong></td>
		<td colspan="7" class="textoM"><em><?php echo nl2br($listar[_amostra]); ?></em></td>
		</tr>
		<tr>
		<td colspan="8">&nbsp;</td>
		</tr>
		...
		<tr>
		<td>&nbsp;</td>
		<td colspan="7"><?php echo nl2br($listar[_resultado]); ?></td>
		</tr>
		<tr>
		<td colspan="2">&nbsp;</td>
		<td colspan="6" valign="top" class="textoM">
		  <strong>Clorado:</strong> cromatografia gasosa
		  <br />
		  <strong>Fosforado:</strong> cromatografia gasosa
		  <br />
		  <strong>Clorofosforados:</strong> cromatografia gasosa
		  <br />
		  <strong>Cumarínico:</strong> colorim&eacute;trico
		  <br />
		  <strong>Piretróide:</strong> HPCL
		  <br />
		  <strong>Estriquinina:</strong> camada delgada
		  <br />
		  <strong>Chumbo:</strong> absor&ccedil;&atilde;o at&ocirc;mica
		  <br />
		  <strong>Arsênico:</strong> absor&ccedil;&atilde;o at&ocirc;mica com gerador de hidreto
		  <br />
		  <strong>Mercúrio:</strong> menor que 0,005mg/kg
		  <br />
		  <strong>Carbamatos:</strong> espectrofotometria de absor&ccedil;&atilde;o at&ocirc;mica com gerador de hidreto
		  </td>
		</tr>
		<tr>
		<td colspan="8">&nbsp;</td>
