...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr><th colspan="8"><strong>MICROBIOLOGIA</strong></th></tr>
	
	<tr>
	<th colspan="8"><strong>CULTURA URINA E ANTIBIOGRAMA VETERIN&Aacute;RIO</strong></th>
	</tr>
	...
	?>
        ...
        <?php
        if($listar[_cultura_fungica_resultado] != 'Meketrefe')
		{
			?>
            <tr>
        ...
        if($listar[_cultura_urina_antibiograma] != 'Meketrefe')
		{
			?>
            <tr>
            ...
            <tr>
            <td colspan="8"><?php echo nl2br($listar[_cultura_urina_antibiograma]); ?></td>
            </tr>
