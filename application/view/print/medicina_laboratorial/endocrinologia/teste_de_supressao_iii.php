...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">CORTISOL  P&Oacute;S SUPRESS&Atilde;O 3 DOSES RIA</th>
	</tr>
	...
	if($listar[_cortisol_4_h] != "Meketrefe")
	{
    ?>
        <tr>
            <td colspan="2"><strong>CORTISOL 4 HORAS P&Oacute;S DEXA</strong></td>
            <td><?php echo $listar[_cortisol_4_h]; ?></td>
            <td colspan="5"><strong>ng/mL</strong></td>
        </tr>
    <?php
	}
    ...
    <tr>
        <td colspan="2">&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="5" class="textoM"><strong>Cortisol basal</strong>: &nbsp; 10,0 a 40 ng/mL <br />
          <strong>Cortisol 4 horas</strong>: &nbsp;0,0 a 15 ng/mL <br />
        <strong>Cortisol 8 horas</strong>: &nbsp;0,0 a 15 ng/mL </td>
    </tr>
	<?php
	/*
