...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">CORTISOL  P&Oacute;S SUPRESS&Atilde;O 2 DOSES RIA</th>
	</tr>
	...
	<td colspan="7" class="textoM"><em>RADIOIMUNOENSAIO</em></td>
	</tr>
	<?php
	if(($listar[_cortisol_basal] != 'Meketrefe'))
	{
		?>
        <tr>
        <td colspan="2"><strong>CORTISOL BASAL</strong></td>
        <td><?php echo $listar[_cortisol_basal]; ?></td>
        <td colspan="5"><strong>ng/mL</strong></td>
        </tr>
        <tr><td colspan="8">&nbsp;</td></tr>
	<?php
	}
	if(($listar[_cortisol_8_h] != 'Meketrefe'))
	{
		?>
        <tr>
          <td colspan="2"><strong>CORTISOL 8 HORAS P&Oacute;S DEXA</strong></td>
          <td><?php echo $listar[_cortisol_8_h]; ?></td>
          <td colspan="5"><strong>ng/mL</strong></td>
        </tr>
        <tr><td colspan="8">&nbsp;</td></tr>
	<?php
	...
	<tr>
        ...
        <br />
		Basal e 4 horas: coleta ap&oacute;s supress&atilde;o: menor que  15 ng/mL
        <br />
		Basal e 8 horas: coleta ap&oacute;s supress&atilde;o: menor que  15 ng/mL
        <br />
        <br />
        <strong>Tumor da adrenal ou PDH</strong>:
        <br />
        Basal e 4 horas: coleta ap&oacute;s supress&atilde;o: maior que  15 ng/mL
        <br />
        Basal e 8 horas: coleta ap&oacute;s supress&atilde;o: maior que  15 ng/mL
        <br />
        <br />
        <strong>Apenas PDH</strong>:
        <br />
        Basal e 8 horas: coleta ap&oacute;s supress&atilde;o: maior  que 15 ng/mL
        </td>
	</tr>
	...
	if(($listar[_observacao] != 'Meketrefe'))
	{
		?>
		<tr>
		<td colspan="5"><strong>Observação</strong></td>
		</tr>
		<tr>
		<td colspan="5" align="justify"><?php echo nl2br($listar[_observacao]); ?></td>
		</tr>
		<?php
	}
	*/
