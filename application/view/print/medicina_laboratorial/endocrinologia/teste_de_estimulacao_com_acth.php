<div class="corpo">
	...
	<tr>
	<th colspan="9"><strong>TESTE DE EST&Iacute;MULA&Ccedil;&Atilde;O COM ACTH</strong></th>
	</tr>
	...
	if(($listar[_cortisol_basal] != 'Meketrefe'))
	{
        ...
        <td colspan="7"><strong>ng/mL</strong></td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        ...
        <tr>
          <td colspan="3">&nbsp;</td>
          <td colspan="6" class="textoM">de  10,0 a 40,0 ng/mL</td>
          </tr>
        <tr>
        <td colspan="9">&nbsp;</td>
        </tr>
	...
	if($listar[_cortisol_p_acth] != 'Meketrefe')
	{
		?>
        <tr>
        <td class="textoM"><strong>Amostra:</strong></td>
        ...
        <tr>
        <td colspan="2"><strong>CORTISOL-P&Oacute;S-ACTH</strong></td>
        <td><?php echo $listar[_cortisol_p_acth]; ?></td>
        ...
        <tr>
          ...
          <td colspan="6" class="textoM">
            40,0 a 130,0 ng/mL (Normal)
            <br />
            &gt; 130,0 ng/mL (Confirmat&oacute;rio S&iacute;ndrome de Cushing)
          </td>
          </tr>
        <tr>
        <td colspan="9">&nbsp;</td>
