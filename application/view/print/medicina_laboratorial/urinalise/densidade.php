...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">DENSIDADE URIN&Aacute;RIA </th>
	</tr>
	...
	<td colspan="8" class="textoM"><em>Urina</em></td>
	</tr>
	<tr>
	<td class="textoM"><strong>M&eacute;todo:</strong></td>
	<td colspan="8" class="textoM"><em>Refrat&ocirc;metro</em></td>
	</tr>
	<tr>
	<td>&nbsp;</td>
	<td colspan="8"><strong>Densidade urin&aacute;ria:</strong></td>
	</tr>
	<tr>
	<td>&nbsp;</td>
	<td colspan="2"><?php echo $listar[_densidade];?></td>
	<td colspan="7" class="textoM">Intervalo de Refer&ecirc;ncia</td>
	</tr>
	<tr>
	<td colspan="3">&nbsp;</td>
	<td colspan="6" class="textoM"><strong>Canino:</strong> <em> 1020 &ndash; 1040</em><br /><strong>Felino:</strong> <em>1020 &ndash; 1060</em></td>
	</tr>
