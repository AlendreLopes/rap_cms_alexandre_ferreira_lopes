...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">PARCIAL DE URINA EQUINO</th>
	</tr>
		...
		)
	{
		...
		if ($listar[_volume] != 'Meketrefe')
		{
			...
			<td colspan="3" align="center" class="textoM">&nbsp;</td>
	        <td>&nbsp;</td>
			</tr>
			<?php
		}
		if ($listar[_densidade] != 'Meketrefe')
		{
			...
			<td colspan="3" align="center" class="textoM">1,020 a 1,060</td>
	        <td>&nbsp;</td>
			</tr>
			<?php
		}
		...
		if ($listar[_ph] != 'Meketrefe')
		{
			...
			<td colspan="3" align="center" class="textoM">5 a 7</td>
	        <td>&nbsp;</td>
			</tr>
			<?php
		}
		...
		)
	{
		...
		if ($listar[_proteinas] != 'Meketrefe')
		{
			...
			<td colspan="3" class="textoM"><em>&lt;  30 mg/dL</em></td>
	        <td>&nbsp;</td>
			</tr>
			<?php
		}
		...
		if ($listar[_urobilinogenio] != 'Meketrefe')
		{
			...
			<td><strong>mg/dL</strong></td>
			<td colspan="3" class="textoM"><em>0,1 - 10 mg/dL</em></td>
	        <td>&nbsp;</td>
			</tr>
			<?php
		}
	...
	?>
		...
		if ($listar[_leucocitos] != 'Meketrefe')
		{
			...
			<td colspan="3" class="textoM"><em>At&eacute; 3 por campo</em></td>
	        <td>&nbsp;</td>
			</tr>
			<?php
		}
		if ($listar[_hemacias] != 'Meketrefe')
		{
			...
			<td colspan="3" class="textoM"><em>Raras  a ocasional</em></td>
	        <td>&nbsp;</td>
			</tr>
			<?php
		}
		...
		if ($listar[_cilindros] != 'Meketrefe')
		{
			...
			<td colspan="3" class="textoM"><em>Granuloso  ou hialino ocasional</em></td>
	        <td>&nbsp;</td>
			</tr>
			<?php
		}
		if ($listar[_cristais] != 'Meketrefe')
		{
			...
			<td colspan="3" class="textoM"><em>Ausente  ou 1+ de carbonato</em></td>
	        <td>&nbsp;</td>
			</tr>
			<?php
		}
