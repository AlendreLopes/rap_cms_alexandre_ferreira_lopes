...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">RELA&Ccedil;&Atilde;O C&Aacute;LCIO : CREATININA</th>
	</tr>
	...
	<tr>
	  ...
	  <td colspan="7" class="textoM">Urina</td>
	  </tr>
	<tr>
	<td>&nbsp;</td>
	<td class="textoM"><strong>M&eacute;todo:</strong></td>
	<td colspan="7" class="textoM">Colorimétrico</td>
	</tr>
	<tr>
	<td>&nbsp;</td>
	<td><strong>Cálcio:</strong></td>
	<td><?php echo $listar[_calcio]; ?></td>
	...
	<td><?php echo $listar[_calcio_creatinina]; ?></td>
	<td colspan="6"><strong>mg/dL</strong></td>
	</tr>
	<tr>
	<td colspan="3">&nbsp;</td>
	...
	<tr>
	<td colspan="3">&nbsp;</td>
	<td class="textoM">0,5 a 2,3 x 10 elevado a -2</td>
	<td colspan="6">&nbsp;</td>
	</tr>
	<tr>
	<td colspan="9">&nbsp;</td>
