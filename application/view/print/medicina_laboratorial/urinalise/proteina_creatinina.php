...
<th colspan="2" align="left"><strong>Dr(a).:</strong></th>
	...
	<tr>
	<th colspan="8">RELA&Ccedil;&Atilde;O PROTE&Iacute;NA : CREATININA</th>
	</tr>
	...
	<tr>
	<td><strong>Prote&iacute;na:</strong></td>
	<td><?php echo $listar[_proteina]; ?></td>
	<td colspan="6"><strong>mg/dL</strong></td>
	</tr>
	<tr>
	<td class="textoM"><strong>Amostra:</strong></td>
	<td colspan="7" class="textoM"><em>Urina</em></td>
	</tr>
	<tr>
	<td class="textoM"><strong>M&eacute;todo:</strong></td>
	<td colspan="7" class="textoM"><em>Vermelho de Pirogalol</em></td>
	</tr>
	<tr>
	<td colspan="8">&nbsp;</td>
	</tr>
	...
	<td><?php echo $listar[_creatinina]; ?></td>
	<td colspan="6"><strong>mg/dL</strong></td>
	</tr>
	<tr>
	<td class="textoM"><strong>Amostra: </strong></td>
	...
	<tr>
	<td class="textoM"><strong>M&eacute;todo:</strong></td>
	<td colspan="7" class="textoM"><em>Colorim&eacute;trico</em></td>
	</tr>
	<tr>
	<td colspan="8">&nbsp;</td>
	</tr>
	<tr>
	<td><strong>Rela&ccedil;&atilde;o:</strong></td>
	<td><?php echo $listar[_proteina_creatinina]; ?></td>
	<td colspan="6"><strong>mg/dL</strong></td>
	</tr>
	<tr>
	<td colspan="3">&nbsp;</td>
	...
	<tr>
	<td colspan="3">&nbsp;</td>
	<td class="textoM">Normal: &lt; 0,2<br />Intermedi&aacute;rio: 0,2  - 1,0<br />Anormal: &gt; 1,0</td>
	<td class="textoM">Normal: &lt; 0,6<br />Question&aacute;vel: 0,6  - 1,0<br />Anormal: &gt; 1,0</td>
	<td colspan="3">&nbsp;</td>
	</tr>
	<tr>
	<td colspan="8">&nbsp;</td>
