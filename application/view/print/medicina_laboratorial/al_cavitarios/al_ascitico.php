<div class="corpo">
	...
	<th align="left"><span class="no_bold"><?php echo $Lista[_protocolo];?></span></th>
	<th colspan="2" align="left" class="no_bold">&nbsp;</th>
	...
	<th align="left"><span class="no_bold"><?php echo $Lista[_paciente];?></span></th>
	<th colspan="2" align="left" class="no_bold">&nbsp;</th>
	...
	<th align="left"><span class="no_bold"><?php echo $Lista[_especie];?></span></th>
	<th colspan="2" align="left" class="no_bold">&nbsp;</th>
	...
	<th align="left"><span class="no_bold"><?php echo $Lista[_raca];?></span></th>
	<th colspan="2" align="left" class="no_bold">&nbsp;</th>
	...
	<th align="left"><span class="no_bold"><?php echo $Lista[_clinica_titulo];?></span></th>
	<th colspan="2" align="left" class="no_bold">&nbsp;</th>
	...
	<tr>
	<th colspan="8">L&Iacute;QUIDO ASC&Iacute;TICO</th>
	</tr>
	...
	if (
		...
		?>
			...
			<tr>
			<td>&nbsp;</td>
			<td><strong>Amilase:</strong></td>
			<td><?php echo $listar[_amilase]; ?></td>
			<td colspan="5"><strong>U/L</strong></td>
			</tr>
		<?php
			}
		}
