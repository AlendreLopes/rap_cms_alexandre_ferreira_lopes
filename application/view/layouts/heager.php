...
<nav class="navbar navbar-expand-lg fixed-top bg-body-tertiary rounded">
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand col-lg-3" href="#">Scrap Heap</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="d-lg-flex col-lg-4 justify-content-lg-end">
                ...
                <button class="btn btn-outline-info me-1">Login</button>

                <button class="btn btn-outline-success me-1">Register</button>
