...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_ml_al_pleural
	(
		_laudo,
		_volume,
		_cor,
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Aчуo Cadastrar Laudo Pleural Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_ml_al_pleural");
}
