...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_ml_p_coprologico
	(
		_laudo,
		_tripsina,
		_fibras,
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Aηγo Cadastrar Laudo Coprolσgico Funcional Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_ml_p_coprologico");
