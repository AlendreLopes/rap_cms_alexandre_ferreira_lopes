...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$c_0_1 = !empty($_POST["c_0_1"]) ? Functions::seg_($_POST["c_0_1"]) : "Negativo";
	
	$c_0_2 = !empty($_POST["c_0_2"]) ? Functions::seg_($_POST["c_0_2"]) : "Negativo";
	
	$c_2 = !empty($_POST["c_2"]) ? Functions::seg_($_POST["c_2"]) : "Negativo";
	
	$c_3 = !empty($_POST["c_3"]) ? Functions::seg_($_POST["c_3"]) : "Meketrefe";
	
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_ml_i_parvovirose
	(
		_laudo,
		_parvovirus,
		_coronavirus,
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Aчуo Cadastrar Laudo Parvovirose Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_ml_i_parvovirose");
