...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$c_4_1 = !empty($_POST["c_4_1"]) ? Functions::seg_($_POST["c_4_1"]) : "Negativo";
	
	$c_5 = !empty($_POST["c_5"]) ? Functions::seg_($_POST["c_5"]) : "Meketrefe";
	
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_ml_i_dirofilariose
	(
		_laudo,
		_dirofilaria,
		_ehrlichia,
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Aчуo Cadastrar Laudo Dirofilariose Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_ml_i_dirofilariose");
}
?>