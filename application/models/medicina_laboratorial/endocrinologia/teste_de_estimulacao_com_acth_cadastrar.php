...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_ml_e_teste_de_estimulacao_com_acth
	(
		_laudo,
		_cortisol_basal,
		_cortisol_p_acth,
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Aзгo Cadastrar Laudo Teste de Supressгo Pуs-ACTH Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_ml_e_teste_de_estimulacao_com_acth");
}
