...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_ml_u_proteina_creatinina
	(
		_laudo,
		_proteina,
		_creatinina,
		_proteina_creatinina,
		_observacao,
		_concluido
	) 
	VALUES 
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Aчуo Cadastrar Laudo Proteina Creatinina Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_ml_u_proteina_creatinina");
