...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_ml_h_contagem_de_plaquetas
	(
		_laudo,
		_plaquetas,
		_plaquetas_a,
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Aчуo Cadastrar Laudo Contagem de Plaquetas Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_ml_h_contagem_de_plaquetas");
