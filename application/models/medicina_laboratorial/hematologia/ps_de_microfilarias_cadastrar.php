...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_ml_h_ps_de_microfilarias
	(
		_laudo,
		_dirofilaria,
		_dipetalonema,
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Ação Cadastrar Laudo PS de Microfilárias Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_ml_h_ps_de_microfilarias");
