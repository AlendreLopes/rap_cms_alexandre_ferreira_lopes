...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_di_us_obstetrica
	(
		_laudo,
		_descricao,
		_concluido
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Aзгo Cadastrar Laudo US para Perfil Biofнsico Fetal Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_di_us_obstetrica");
