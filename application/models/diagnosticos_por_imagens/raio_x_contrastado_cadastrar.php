...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$Resultado = $SQL -> Inserir("INSERT INTO laudos_di_raio_x_contrastado
	(
		_laudo,
		_tecnica,
		_descricao,
	...
	if($Resultado)
	{
		...
		$L_2 = $_COOKIE['sl_hash'];
		$L_3 = "cadastrar";
		$L_4 = "Aчуo Cadastrar Laudo Raio-x Contrastado Protocolo: $c_0";
	...
	$Otimizar = $SQL -> Atualizar("OPTIMIZE TABLE laudos_di_raio_x_contrastado");
