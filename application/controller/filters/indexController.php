...
if($_SERVER['REQUEST_METHOD'] == "GET")
{
	...
	{
		// Verifica a existência de "_visualizar" na variável página
	...
	{
		// Verifica a existência de "_imagens" na variável página
		$caminho = "application/view/scripts/acessar_formularios/imagens.php";
	}
	else if(preg_match("/_imagem_editar/i",$pagina))
	{
		// Verifica a existência de "_imagem_editar" na variável página
