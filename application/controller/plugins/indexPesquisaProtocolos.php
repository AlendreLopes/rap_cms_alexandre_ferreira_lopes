...
<head>
	...
	<title>Protocolos Listar Procura</title>

	<script type="text/javascript">
		$("input[name=protocolos]").val("");
	</script>
		...
		<tbody>
			...
			if ($Laudos) {
				...
				while ($Listar = mysql_fetch_array($Laudo)) {
					?>
					<tr>
						<td align="center"><a href="<?php echo LMPaginas::Listar('cadastrar', $Listar['protocolo_id']); ?>"
								title="Protocolo: <?php echo $Listar['_protocolo']; ?>"><?php echo $Listar['_protocolo']; ?></a>
						</td>
			...
			<tbody>
				...
				if ($citopatologias) {
					while ($listar = mysql_fetch_array($citopatologia)) {
						...
						<tr>
							<td align="center"><a
									href="<?php echo LMPaginas::Listar('citopatologia_visualizar', $i); ?>"><?php echo $p; ?></a></td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($citopatologia_vaginals) {
					while ($listar = mysql_fetch_array($citopatologia_vaginal)) {
						...
						<tr>
							<td align="center"><a
									href="<?php echo LMPaginas::Listar('citopatologia_vaginal_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($histopatologias) {
					while ($listar = mysql_fetch_array($histopatologia)) {
						...
						<tr>
							<td align="center"><a
									href="<?php echo LMPaginas::Listar('histopatologia_visualizar', $i); ?>"><?php echo $p; ?></a></td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
							<td align="center"><?php echo $solicitado; ?></td>
				...
				if ($necropsias) {
					while ($listar = mysql_fetch_array($necropsia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('necropsia_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($endoscopias) {
					while ($listar = mysql_fetch_array($endoscopia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('endoscopia_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($raio_xs) {
					while ($listar = mysql_fetch_array($raio_x)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('raio_x_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($raio_x_contrastados) {
					while ($listar = mysql_fetch_array($raio_x_contrastado)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('raio_x_contrastado_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($us_aparelho_femininos) {
					while ($listar = mysql_fetch_array($us_aparelho_feminino)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('us_aparelho_feminino_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($us_estruturas) {
					while ($listar = mysql_fetch_array($us_estrutura)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('us_estruturas_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($us_exploratorias) {
					while ($listar = mysql_fetch_array($us_exploratoria)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('us_exploratoria_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($us_gestacionals) {
					while ($listar = mysql_fetch_array($us_gestacional)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('us_gestacional_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($us_obstetricas) {
					while ($listar = mysql_fetch_array($us_obstetrica)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('us_obstetrica_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($us_pos_partos) {
					while ($listar = mysql_fetch_array($us_pos_parto)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('us_pos_parto_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($asciticos) {
					while ($listar = mysql_fetch_array($ascitico)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('al_ascitico_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($liquors) {
					while ($listar = mysql_fetch_array($liquor)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('al_liquor_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($pericardios) {
					while ($listar = mysql_fetch_array($pericardio)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('al_pericardio_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($pleurals) {
					while ($listar = mysql_fetch_array($pleural)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('al_pleural_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($sinovials) {
					while ($listar = mysql_fetch_array($sinovial)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('al_sinovial_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($biologias) {
					while ($listar = mysql_fetch_array($biologia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('biologia_molecular_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($bioquimicas) {
					while ($listar = mysql_fetch_array($bioquimica)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('bioquimica_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($doencas) {
					while ($listar = mysql_fetch_array($doenca)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('doencas_geneticas_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($brometos) {
					while ($listar = mysql_fetch_array($brometo)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('brometo_de_potassio_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($digoxinas) {
					while ($listar = mysql_fetch_array($digoxina)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('digoxina_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($fenobarbitals) {
					while ($listar = mysql_fetch_array($fenobarbital)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('fenobarbital_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($e_endocrinologias) {
					while ($listar = mysql_fetch_array($e_endocrinologia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('endocrinologias_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($e_endocrinologia_rias) {
					while ($listar = mysql_fetch_array($e_endocrinologia_ria)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('endocrinologias_ria_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($e_relatorios) {
					while ($listar = mysql_fetch_array($e_relatorio)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('relatorio_de_exames_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($e_teste_de_estimulacao_com_acths) {
					while ($listar = mysql_fetch_array($e_teste_de_estimulacao_com_acth)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('teste_de_estimulacao_com_acth_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($e_teste_de_supressao_is) {
					while ($listar = mysql_fetch_array($e_teste_de_supressao_i)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('teste_de_supressao_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($e_teste_de_supressao_iis) {
					while ($listar = mysql_fetch_array($e_teste_de_supressao_ii)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('teste_de_supressao_ii_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($e_teste_de_supressao_iiis) {
					while ($listar = mysql_fetch_array($e_teste_de_supressao_iii)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('teste_de_supressao_iii_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($geneticas) {
					while ($listar = mysql_fetch_array($genetica)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('genetica_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($plaquetas) {
					while ($listar = mysql_fetch_array($plaqueta)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('contagem_de_plaquetas_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($reticulocitos) {
					while ($listar = mysql_fetch_array($reticulocito)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('contagem_de_reticulocitos_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($eritrogramas) {
					while ($listar = mysql_fetch_array($eritrograma)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('eritrograma_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($fibrogenios) {
					while ($listar = mysql_fetch_array($fibrogenio)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('fibrogenio_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hematocritos) {
					while ($listar = mysql_fetch_array($hematocrito)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('hematocrito_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hemograma_bovinos) {
					while ($listar = mysql_fetch_array($hemograma_bovino)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('hemograma_bovino_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hemograma_caprinos) {
					while ($listar = mysql_fetch_array($hemograma_caprino)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('hemograma_caprino_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hemograma_equinos) {
					while ($listar = mysql_fetch_array($hemograma_equino)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('hemograma_equino_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hemograma_is) {
					while ($listar = mysql_fetch_array($hemograma_i)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('hemograma_i_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hemograma_iis) {
					while ($listar = mysql_fetch_array($hemograma_ii)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('hemograma_ii_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hemograma_iiis) {
					while ($listar = mysql_fetch_array($hemograma_iii)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('hemograma_iii_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hemograma_ovino) {
					while ($listar = mysql_fetch_array($hemograma_ovino)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('hemograma_ovino_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($kit_hematozoarios) {
					while ($listar = mysql_fetch_array($kit_hematozoario)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('kit_hematozoarios_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($leucogramas) {
					while ($listar = mysql_fetch_array($leucograma)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('leucograma_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($lentzs) {
					while ($listar = mysql_fetch_array($lentz)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('ps_de_corpusculo_de_lentz_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hematozoario_is) {
					while ($listar = mysql_fetch_array($hematozoario_i)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('ps_de_hematozoarios_i_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($hematozoario_iis) {
					while ($listar = mysql_fetch_array($hematozoario_ii)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('ps_de_hematozoarios_ii_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($microfilarias) {
					while ($listar = mysql_fetch_array($microfilaria)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('ps_de_microfilarias_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($ehrlichioses) {
					while ($listar = mysql_fetch_array($ehrlichiose)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('ps_de_ehrlichiose_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($taps) {
					while ($listar = mysql_fetch_array($tap)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('tap_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($ttps) {
					while ($listar = mysql_fetch_array($ttp)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('ttp_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($vhss) {
					while ($listar = mysql_fetch_array($vhs)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('vhs_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($bruceloses) {
					while ($listar = mysql_fetch_array($brucelose)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('brucelose_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($cinomose_ifis) {
					while ($listar = mysql_fetch_array($cinomose_ifi)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('cinomose_ifi_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($cinomose_sorologias) {
					while ($listar = mysql_fetch_array($cinomose_sorologia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('cinomose_sorologia_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($cinomose_testes) {
					while ($listar = mysql_fetch_array($cinomose_teste)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('cinomose_teste_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($dirofilarioses) {
					while ($listar = mysql_fetch_array($dirofilariose)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('dirofilariose_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($fiv_felvs) {
					while ($listar = mysql_fetch_array($fiv_felv)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('fiv_felv_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($giardias) {
					while ($listar = mysql_fetch_array($giardia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('giardia_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($leishmanioses) {
					while ($listar = mysql_fetch_array($leishmaniose)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('leishmaniose_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($leptospiroses) {
					while ($listar = mysql_fetch_array($leptospirose)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('leptospirose_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($parvoviroses) {
					while ($listar = mysql_fetch_array($parvovirose)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('parvovirose_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($pifs) {
					while ($listar = mysql_fetch_array($pif)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('pif_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($toxoplasmoses) {
					while ($listar = mysql_fetch_array($toxoplasmose)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('toxoplasmose_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($m_culturas) {
					while ($listar = mysql_fetch_array($m_cultura)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('cultura_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($m_cultura_fs) {
					while ($listar = mysql_fetch_array($m_cultura_f)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('cultura_fungica_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($m_cultura_us) {
					while ($listar = mysql_fetch_array($m_cultura_u)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('cultura_urina_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($microscopias) {
					while ($listar = mysql_fetch_array($microscopia)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('microscopia_eletronica_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($lipase_imuno_reativa_caninas) {
					while ($listar = mysql_fetch_array($lipase_imuno_reativa_canina)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('lipase_imuno_reativa_canina_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($coprologicos) {
					while ($listar = mysql_fetch_array($coprologico)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('coprologico_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($coproparasitologico_is) {
					while ($listar = mysql_fetch_array($coproparasitologico_i)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('coproparasitologico_i_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($coproparasitologico_iis) {
					while ($listar = mysql_fetch_array($coproparasitologico_ii)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('coproparasitologico_ii_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($ectoparasitas) {
					while ($listar = mysql_fetch_array($ectoparasita)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('ectoparasitas_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($parasitologias) {
					while ($listar = mysql_fetch_array($parasitologia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('parasitologia_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($_sangue_ocultos) {
					while ($listar = mysql_fetch_array($_sangue_oculto)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('ps_de__sangue_oculto_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($alergias) {
					while ($listar = mysql_fetch_array($alergia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('teste_de_alergia_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($toxicologicos) {
					while ($listar = mysql_fetch_array($toxicologico)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('toxicologico_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($analise_fisicos) {
					while ($listar = mysql_fetch_array($analise_fisico)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('analise_fisico_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($calcio_creatininas) {
					while ($listar = mysql_fetch_array($calcio_creatinina)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('calcio_creatinina_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($densidades) {
					while ($listar = mysql_fetch_array($densidade)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('densidade_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($parcials) {
					while ($listar = mysql_fetch_array($parcial)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('parcial_de_urina_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($u_parcial_de_urina_equinos) {
					while ($listar = mysql_fetch_array($u_parcial_de_urina_equino)) {
						...
						<tr>
							<td align="center">
								<a
									href="<?php echo LMPaginas::Listar('parcial_de_urina_equino_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($proteina_creatininas) {
					while ($listar = mysql_fetch_array($proteina_creatinina)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('proteina_creatinina_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($transcrevers) {
					while ($listar = mysql_fetch_array($transcrever)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('transcrever_exames_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($acupunturas) {
					while ($listar = mysql_fetch_array($acupuntura)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('acupuntura_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($eletrocardiogramas) {
					while ($listar = mysql_fetch_array($eletrocardiograma)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('eletrocardiograma_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($endocrinologias) {
					while ($listar = mysql_fetch_array($endocrinologia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('endocrinologia_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($fisioterapias) {
					while ($listar = mysql_fetch_array($fisioterapia)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('fisioterapia_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
				...
				if ($mpass) {
					while ($listar = mysql_fetch_array($mpas)) {
						...
						<tr>
							<td align="center">
								<a href="<?php echo LMPaginas::Listar('mpas_visualizar', $i); ?>"><?php echo $p; ?></a>
							</td>
							<td><?php echo $p_; ?></td>
							<td><?php echo $g; ?></td>
							<td><?php echo $c; ?></td>
