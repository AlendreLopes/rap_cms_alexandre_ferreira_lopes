<fieldset>
	...
	<span class="ep_" numero="<?php echo $Numero;?>" celula="_proprietario"><span class="ep_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_proprietario];?></span></span>
	...
	<strong>Dr(a).:</strong>
	<span class="ep_" numero="<?php echo $Numero;?>" celula="_requisitante"><span class="ep_<?php echo $Numero;?>" <?php $Numero ++;?>><?php echo $Exame[_requisitante];?></span></span>
