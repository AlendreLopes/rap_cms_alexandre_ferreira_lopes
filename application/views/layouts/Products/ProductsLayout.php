...
<head>
    ...
    <!-- CSS Main -->
    <link rel="stylesheet" href="/public/assets/styles/main.partials.css">
...
<body>
    ...
    <footer class="w-100 mt-5">
        <!-- Footer Upper -->
        <?php require Views::controllers('site/partials/footer.upper.php'); ?>
        <!-- Footer Lower -->
        <?php require Views::controllers('site/partials/footer.lower.php'); ?>
    </footer>
