...
<table class="tablesorter" cellpadding="1">
	...
	<thead>
		<tr>
			<th width="30%" scope="col" align="center"><a href="exames" tabela="cadastrarExame"
					indice="<?php echo $Indice; ?>" data="<?php echo $Data; ?>" title="Solicitar Laudos">Exames</a></th>
			<th width="50%" scope="col" align="center"><a href="exames" tabela="cadastrarExame"
					indice="<?php echo $Indice; ?>" data="<?php echo $Data; ?>" title="Solicitar Laudos">Titulos</a></th>
		...
		if ($Solicitados) {
			...
			while ($Listar = mysql_fetch_array($Solicitado)) {
				...
				<tr>
					...
					<td align="center">
						<div id="solicitados" indice="<?php echo $Listar[solicitado_id]; ?>"
							laudo="<?php echo $Listar[solicitado_laudo]; ?>" numero="<?php echo $Numero; ?>">
							<span id="<?php echo $Numero; ?>"><?php echo $Listar[solicitado_valores]; ?></span>
						</div>
					</td>
					<td align="center">
						<a href="application/controller/filters/indexEdit.php?t_t=tb_laudos_solicitados&amp;c_i=solicitado_id&amp;c_i_v=<?php echo $Listar[solicitado_id]; ?>&amp;c_t=solicitado_excluir&amp;c_t_v=<?php echo $Listar[solicitado_laudo]; ?>&amp;TB_iframe=true&amp;modal=true"
							class="thickbox" title="Excluir Exame"><img src="/public/image/Deletar.jpg" /></a>
					</td>
				</tr>
				<?php
