...
<head>
    ...
    <title>RAP CMS - <?= $title ?? 'Users' ?></title>
...
<body class="align-items-center py-4 bg-body-tertiary">
    ...
    <main class="mx-auto w-100 mt-3 py-5">
        ...
        <div class="d-flex flex mt-5 px-3">
    ...
    <?php if (isset($title) && $title == 'Create Address'): ?>
        ...
        <!-- Jquery Via CEP -->
        <script src="/node_modules/@vsilva472/jquery-viacep/dist/jquery-viacep.min.js"></script>
        <script>
            $(function () {
                $('#zip_code').mask('00000-000');
                $(".userAddress").click(function () {
                    var lurl = String($(this).attr('data-id'));
                    alert(lurl);
