<div class="container mt-2 p-3 rounded text-body-emphasis bg-body-secondary shadow">
    ...
    <form id="productsDependenciesForm" action="/administrators/sizes/update" class="mb-4" method="POST">

        <input type="hidden" name="_method" value="PATCH">

        <input type="hidden" name="id" value="<?= $edit['id'] ?>"></div>
        ...
        <div class="row mb-2">
            ...
            <div class="row mb-2">
                ...
                <div class="col text-end">
                    ...
                    <a href="/administrators/sizes" class="btn btn-outline-secondary">Cancel</a>
