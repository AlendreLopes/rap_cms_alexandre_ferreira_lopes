<div class="form-signin w-100 m-auto">
    ...
    <form id="userLoginForm" action="/admins/login/store" method="POST">
        ...
        <div class="form-control mb-2">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="name@example.com" value="<?= old('email') ?? '' ?>" require>
        </div>

        <div class="form-control mb-2">
            <label class="form-label" for="password"><i id="eyeSlash" class="fas fa-eye-slash"
                    style="cursor: pointer;"></i> Password</label>
            <input type="password" class="form-control" id="password" name="password" placeholder="Password" value="<?= old('password') ?? '' ?>" require>
        </div>
